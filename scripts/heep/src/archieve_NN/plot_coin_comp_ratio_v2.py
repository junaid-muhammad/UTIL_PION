...
N_data = P_kin_secondary_W_protons_data_prompt_cut_all.IntegralAndError(1,nbins,dN_data_error,"")
N_dummy = P_kin_secondary_W_protons_dummy_prompt_cut_all.IntegralAndError(1,nbins,dN_dummy_error,"")
N_simc = W_protons_simc_cut_all.IntegralAndError(1,nbins,dN_simc_error,"")

dataSimcRatio = (N_data) / N_simc

dataSimcRatio_err = dataSimcRatio * ma.sqrt((dN_data_error[0]/N_data)**2 + (dN_simc_error[0]/N_simc)**2)

...
total_data_effective_charge_error = 0.0
total_dummy_effective_charge_error = 0.0
...
#    data_charge_error = row['BCM2_Charge_Error']
...
#    data_edtm_livetime_Corr_error = row['Non_Scaler_EDTM_Live_Time_Error']
...
# Calculate error propagation
    data_product_error = (
        ((data_hms_tracking_efficiency * data_shms_tracking_efficiency
          * hms_Cer_detector_efficiency * hms_Cal_detector_efficiency
          * data_hms_hodo_3_of_4_efficiency * data_shms_hodo_3_of_4_efficiency
          * data_edtm_livetime_Corr * data_Boiling_factor) * data_charge_error)**2 +
        ((data_charge * data_shms_tracking_efficiency
          * hms_Cer_detector_efficiency * hms_Cal_detector_efficiency
          * data_hms_hodo_3_of_4_efficiency * data_shms_hodo_3_of_4_efficiency
          * data_edtm_livetime_Corr * data_Boiling_factor) * data_hms_tracking_efficiency_error)**2 +
        ((data_charge * data_hms_tracking_efficiency
          * hms_Cer_detector_efficiency * hms_Cal_detector_efficiency
          * data_hms_hodo_3_of_4_efficiency * data_shms_hodo_3_of_4_efficiency
          * data_edtm_livetime_Corr * data_Boiling_factor) * data_shms_tracking_efficiency_error)**2 +
        ((data_charge * data_hms_tracking_efficiency * data_shms_tracking_efficiency
          * hms_Cal_detector_efficiency
          * data_hms_hodo_3_of_4_efficiency * data_shms_hodo_3_of_4_efficiency
          * data_edtm_livetime_Corr * data_Boiling_factor) * hms_Cer_detector_efficiency_error)**2 +
        ((data_charge * data_hms_tracking_efficiency * data_shms_tracking_efficiency
          * hms_Cer_detector_efficiency
          * data_shms_hodo_3_of_4_efficiency * data_edtm_livetime_Corr * data_Boiling_factor) * hms_Cal_detector_efficiency_error)**2 +
        ((data_charge * data_hms_tracking_efficiency * data_shms_tracking_efficiency
          * hms_Cer_detector_efficiency * hms_Cal_detector_efficiency
          * data_shms_hodo_3_of_4_efficiency * data_edtm_livetime_Corr * data_Boiling_factor) * data_hms_hodo_3_of_4_efficiency_error)**2 +
        ((data_charge * data_hms_tracking_efficiency * data_shms_tracking_efficiency
          * hms_Cer_detector_efficiency * hms_Cal_detector_efficiency
          * data_hms_hodo_3_of_4_efficiency * data_edtm_livetime_Corr * data_Boiling_factor) * data_shms_hodo_3_of_4_efficiency_error)**2 +
        ((data_charge * data_hms_tracking_efficiency * data_shms_tracking_efficiency
          * hms_Cer_detector_efficiency * hms_Cal_detector_efficiency
          * data_hms_hodo_3_of_4_efficiency * data_shms_hodo_3_of_4_efficiency
          * data_Boiling_factor * data_edtm_livetime_Corr) * data_Boiling_factor_error)**2 +
        ((data_charge * data_hms_tracking_efficiency * data_shms_tracking_efficiency
          * hms_Cer_detector_efficiency * hms_Cal_detector_efficiency
          * data_hms_hodo_3_of_4_efficiency * data_shms_hodo_3_of_4_efficiency
          * data_edtm_livetime_Corr * data_Boiling_factor) * data_edtm_livetime_Corr_error)**2
    ) ** 0.5
    total_data_effective_charge_error += data_product_error
'''
...
H_gtr_beta_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_beta_protons_data_prompt_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", nbins, 0.8, 1.2)
H_gtr_xp_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_xp_protons_data_prompt_cut_all", "HMS xptar; HMS_gtr_xptar; Counts", nbins, -0.2, 0.2)
H_gtr_yp_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_yp_protons_data_prompt_cut_all", "HMS yptar; HMS_gtr_yptar; Counts", nbins, -0.2, 0.2)
H_gtr_dp_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_dp_protons_data_prompt_cut_all", "HMS #delta; HMS_gtr_dp; Counts", nbins, -15, 15)
H_gtr_p_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_p_protons_data_prompt_cut_all", "HMS p; HMS_gtr_p; Counts", nbins, 4, 8)
H_dc_x_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_x_fp_protons_data_prompt_cut_all", "HMS x_fp'; HMS_dc_x_fp; Counts", nbins, -100, 100)
H_dc_y_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_y_fp_protons_data_prompt_cut_all", "HMS y_fp'; HMS_dc_y_fp; Counts", nbins, -100, 100)
H_dc_xp_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_xp_fp_protons_data_prompt_cut_all", "HMS xp_fp'; HMS_dc_xp_fp; Counts", nbins, -0.2, 0.2)
H_dc_yp_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_yp_fp_protons_data_prompt_cut_all", "HMS yp_fp'; HMS_dc_yp_fp; Counts", nbins, -0.2, 0.2)
H_hod_goodscinhit_protons_data_prompt_cut_all = ROOT.TH1D("H_hod_goodscinhit_protons_data_prompt_cut_all", "HMS hod goodscinhit; HMS_hod_goodscinhi; Counts", nbins, 0.7, 1.3)
H_hod_goodstarttime_protons_data_prompt_cut_all = ROOT.TH1D("H_hod_goodstarttime_protons_data_prompt_cut_all", "HMS hod goodstarttime; HMS_hod_goodstarttime; Counts", nbins, 0.7, 1.3)
H_cal_etotnorm_protons_data_prompt_cut_all = ROOT.TH1D("H_cal_etotnorm_protons_data_prompt_cut_all", "HMS cal etotnorm; HMS_cal_etotnorm; Counts", nbins, 0.2, 1.8)
H_cal_etottracknorm_protons_data_prompt_cut_all = ROOT.TH1D("H_cal_etottracknorm_protons_data_prompt_cut_all", "HMS cal etottracknorm; HMS_cal_etottracknorm; Counts", nbins, 0.2, 1.8)
H_cer_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("H_cer_npeSum_protons_data_prompt_cut_all", "HMS cer npeSum; HMS_cer_npeSum; Counts", nbins, 0, 50)
H_RFTime_Dist_protons_data_prompt_cut_all = ROOT.TH1D("H_RFTime_Dist_protons_data_prompt_cut_all", "HMS RFTime; HMS_RFTime; Counts", nbins, 0, 4)
P_gtr_beta_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_beta_protons_data_prompt_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", nbins, 0.5, 1.3)
P_gtr_xp_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_xp_protons_data_prompt_cut_all", "SHMS xptar; SHMS_gtr_xptar; Counts", nbins, -0.2, 0.2)
P_gtr_yp_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_yp_protons_data_prompt_cut_all", "SHMS yptar; SHMS_gtr_yptar; Counts", nbins, -0.2, 0.2)
P_gtr_dp_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_dp_protons_data_prompt_cut_all", "SHMS delta; SHMS_gtr_dp; Counts", nbins, -30, 30)
P_gtr_p_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_p_protons_data_prompt_cut_all", "SHMS p; SHMS_gtr_p; Counts", nbins, 1, 7)
P_dc_x_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_x_fp_protons_data_prompt_cut_all", "SHMS x_fp'; SHMS_dc_x_fp; Counts", nbins, -100, 100)
P_dc_y_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_y_fp_protons_data_prompt_cut_all", "SHMS y_fp'; SHMS_dc_y_fp; Counts", nbins, -100, 100)
P_dc_xp_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_xp_fp_protons_data_prompt_cut_all", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", nbins, -0.2, 0.2)
P_dc_yp_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_yp_fp_protons_data_prompt_cut_all", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", nbins, -0.2, 0.2)
P_hod_goodscinhit_protons_data_prompt_cut_all = ROOT.TH1D("P_hod_goodscinhit_protons_data_prompt_cut_all", "SHMS hod goodscinhit; SHMS_hod_goodscinhit; Counts", nbins, 0.7, 1.3)
P_hod_goodstarttime_protons_data_prompt_cut_all = ROOT.TH1D("P_hod_goodstarttime_protons_data_prompt_cut_all", "SHMS hod goodstarttime; SHMS_hod_goodstarttime; Counts", nbins, 0.7, 1.3)
P_cal_etotnorm_protons_data_prompt_cut_all = ROOT.TH1D("P_cal_etotnorm_protons_data_prompt_cut_all", "SHMS cal etotnorm; SHMS_cal_etotnorm; Counts", nbins, 0, 1)
P_cal_etottracknorm_protons_data_prompt_cut_all = ROOT.TH1D("P_cal_etottracknorm_protons_data_prompt_cut_all", "SHMS cal etottracknorm; SHMS_cal_etottracknorm; Counts", nbins, 0, 1.6)
P_hgcer_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("P_hgcer_npeSum_protons_data_prompt_cut_all", "SHMS HGC npeSum; SHMS_hgcer_npeSum; Counts", nbins, 0, 50)
P_hgcer_xAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_hgcer_xAtCer_protons_data_prompt_cut_all", "SHMS HGC xAtCer; SHMS_hgcer_xAtCer; Counts", nbins, -60, 60)
P_hgcer_yAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_hgcer_yAtCer_protons_data_prompt_cut_all", "SHMS HGC yAtCer; SHMS_hgcer_yAtCer; Counts", nbins, -50, 50)
P_ngcer_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("P_ngcer_npeSum_protons_data_prompt_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", nbins, 0, 50)
P_ngcer_xAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_ngcer_xAtCer_protons_data_prompt_cut_all", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", nbins, -60, 60)
P_ngcer_yAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_ngcer_yAtCer_protons_data_prompt_cut_all", "SHMS NGC yAtCer; SHMS_ngcer_yAtCer; Counts", nbins, -50, 50)
P_aero_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("P_aero_npeSum_protons_data_prompt_cut_all", "SHMS aero npeSum; SHMS_aero_npeSum; Counts", nbins, 0, 50)
P_aero_xAtAero_protons_data_prompt_cut_all = ROOT.TH1D("P_acero_xAtAero_protons_data_prompt_cut_all", "SHMS aero xAtAero; SHMS_aero_xAtAero; Counts", nbins, -60, 60)
P_aero_yAtAero_protons_data_prompt_cut_all = ROOT.TH1D("P_aero_yAtAero_protons_data_prompt_cut_all", "SHMS aero yAtAero; SHMS_aero_yAtAero; Counts", nbins, -50, 50)
P_kin_MMp_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_MMp_protons_data_prompt_cut_all", "MIssing Mass data (prompt_cut_all); MM_{p}; Counts", nbins, -1., 1.)
P_RFTime_Dist_protons_data_prompt_cut_all = ROOT.TH1D("P_RFTime_Dist_protons_data_prompt_cut_all", "SHMS RFTime; SHMS_RFTime; Counts", nbins, 0, 4)
CTime_epCoinTime_ROC1_protons_data_prompt_cut_all = ROOT.TH1D("CTime_epCoinTime_ROC1_protons_data_prompt_cut_all", "Electron-Proton CTime; e p Coin_Time; Counts", nbins, -50, 50)
P_kin_secondary_pmiss_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_protons_data_prompt_cut_all", "Momentum Distribution; pmiss; Counts", nbins_p, -1.2, 1.2)
P_kin_secondary_pmiss_x_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_x_protons_data_prompt_cut_all", "Momentum_x Distribution; pmiss_x; Counts", nbins_p, -1.0, 1.0)
P_kin_secondary_pmiss_y_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_y_protons_data_prompt_cut_all", "Momentum_y Distribution; pmiss_y; Counts", nbins_p, -1.0, 1.0)
P_kin_secondary_pmiss_z_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_z_protons_data_prompt_cut_all", "Momentum_z Distribution; pmiss_z; Counts", nbins_p, -1.0, 1.0)
P_kin_secondary_Erecoil_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Erecoil_protons_data_prompt_cut_all", "Erecoil Distribution; Erecoil; Counts", nbins, -0.6, 0.6)
P_kin_secondary_emiss_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_emiss_protons_data_prompt_cut_all", "Energy Distribution; emiss; Counts", nbins_p, -1.0, 1.0)
P_kin_secondary_Mrecoil_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_data_prompt_cut_all", "Mrecoil Distribution; Mrecoil; Counts", nbins, -0.8, 0.8)
P_kin_secondary_W_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_data_prompt_cut_all", "W Distribution; W; Counts", nbins, 0, 2)
MMsquared_data_prompt_cut_all = ROOT.TH1D("MMsquared_data_prompt_cut_all", "Missing Mass Squared; MM^{2}_{p}; Counts", nbins, -1., 1.)
...
P_kin_MMp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_MMp_protons_dummy_prompt_cut_all", "MIssing Mass dummy (prompt_cut_all); MM_{p}; Counts", nbins, -1., 1.)
...
P_kin_MMp_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_MMp_protons_dummysub_data_cut_all", "MIssing Mass data (dummysub_cut_all); MM_{p}; Counts", nbins, -1., 1.)
...
MMp_protons_simc_cut_all = ROOT.TH1D("MMp_protons_simc_cut_all", "MIssing Mass SIMC (cut_all); MM_{p}; Counts", nbins, -1, 1)
...
# Data Normalization
P_kin_secondary_W_protons_data_prompt_cut_all.Scale(normfac_data)
...
N_data_error = P_kin_secondary_W_protons_data_prompt_cut_all.IntegralAndError(1,nbins,dN_data_error,"")
N_dummy_error = P_kin_secondary_W_protons_dummy_prompt_cut_all.IntegralAndError(1,nbins,dN_dummy_error,"")
N_simc_error = W_protons_simc_cut_all.IntegralAndError(1,nbins,dN_simc_error,"")

dataSimcRatio_err = dataSimcRatio_W * ma.sqrt((dN_data_error[0]/N_data_error)**2 + (dN_dummy_error[0]/N_dummy_error)**2 + (dN_simc_error[0]/N_simc_error)**2)


#N_data_error = int(P_kin_secondary_W_protons_data_prompt_cut_all.Integral())
#N_dummy_error = int(P_kin_secondary_W_protons_dummy_prompt_cut_all.Integral())
#N_simc_error = int(W_protons_simc_cut_all.Integral())
#N_data_normalized = N_data_error * normfac_data
#N_dummy_normalized = N_dummy_error * normfac_dummy
#N_simc_normalized = N_simc_error * normfac_simc

#dN_data_error = math.sqrt(N_data_error)
#dN_dummy_error = math.sqrt(N_dummy_error)
#dN_simc_error = math.sqrt(N_simc_error)

#dataSimcRatio_err = dataSimcRatio_W * ma.sqrt((dN_data_error/N_data_error)**2 + (dN_dummy_error/dN_dummy_error)**2 + (dN_simc_error/N_simc_error)**2)
# Calculate the percentage error
#dataSimcRatio_err = (dataSimcRatio_error / dataSimcRatio_W) * 100
...
errordN_simc_pmiss_x = array.array('d', [0.0])
...
dN_data_hms_dp = math.sqrt(N_data_hms_dp)
dN_data_shms_dp = math.sqrt(N_data_shms_dp)
dN_data_hms_xp = math.sqrt(N_data_hms_xp)
dN_data_hms_yp = math.sqrt(N_data_hms_yp)
dN_data_shms_xp = math.sqrt(N_data_shms_xp)
dN_data_shms_yp = math.sqrt(N_data_shms_yp)
dN_data_hms_xpfp = math.sqrt(N_data_hms_xpfp)
dN_data_hms_ypfp = math.sqrt(N_data_hms_ypfp)
dN_data_shms_xpfp = math.sqrt(N_data_shms_xpfp)
dN_data_shms_ypfp = math.sqrt(N_data_shms_ypfp)
#dN_data_pmiss_x = math.sqrt(N_data_pmiss_x)
dN_data_pmiss_y = math.sqrt(N_data_pmiss_y)
dN_data_pmiss_z = math.sqrt(N_data_pmiss_z)
dN_data_pmiss = math.sqrt(N_data_pmiss)
dN_data_emiss = math.sqrt(N_data_emiss)
dN_data_W = math.sqrt(N_data_W)

dN_simc_hsdelta = math.sqrt(N_simc_hsdelta)
dN_simc_ssdelta = math.sqrt(N_simc_ssdelta)
dN_simc_hsxptar = math.sqrt(N_simc_hsxptar)
dN_simc_hsyptar = math.sqrt(N_simc_hsyptar)
dN_simc_ssxptar = math.sqrt(N_simc_ssxptar)
dN_simc_ssyptar = math.sqrt(N_simc_ssyptar)
dN_simc_hsxpfp = math.sqrt(N_simc_hsxpfp)
dN_simc_hsypfp = math.sqrt(N_simc_hsypfp)
dN_simc_ssxpfp = math.sqrt(N_simc_ssxpfp)
dN_simc_ssypfp = math.sqrt(N_simc_ssypfp)
#dN_simc_pmiss_x = math.sqrt(N_simc_pmiss_x)
dN_simc_pmiss_y = math.sqrt(N_simc_pmiss_y)
dN_simc_pmiss_z = math.sqrt(N_simc_pmiss_z)
dN_simc_pmiss = math.sqrt(N_simc_pmiss)
dN_simc_emiss = math.sqrt(N_simc_emiss)
dN_simc_W = math.sqrt(N_simc_W)

dataSimcRatio_err_hdelta = dataSimcRatio_hdelta * ma.sqrt((dN_data_hms_dp[0]/N_data_hms_dp)**2 + (dN_simc_hsdelta[0]/N_simc_hsdelta)**2)
dataSimcRatio_err_pdelta = dataSimcRatio_pdelta * ma.sqrt((dN_data_shms_dp[0]/N_data_shms_dp)**2 + (dN_simc_ssdelta[0]/N_simc_ssdelta)**2)
dataSimcRatio_err_hxptar = dataSimcRatio_hxptar * ma.sqrt((dN_data_hms_xp[0]/N_data_hms_xp)**2 + (dN_simc_hsxptar[0]/N_simc_hsxptar)**2)
dataSimcRatio_err_hyptar = dataSimcRatio_hyptar * ma.sqrt((dN_data_hms_yp[0]/N_data_hms_yp)**2 + (dN_simc_hsyptar[0]/N_simc_hsyptar)**2)
dataSimcRatio_err_pxptar = dataSimcRatio_pxptar * ma.sqrt((dN_data_shms_xp[0]/N_data_shms_xp)**2 + (dN_simc_ssxptar[0]/N_simc_ssxptar)**2)
dataSimcRatio_err_pyptar = dataSimcRatio_pyptar * ma.sqrt((dN_data_shms_yp[0]/N_data_shms_yp)**2 + (dN_simc_ssyptar[0]/N_simc_ssyptar)**2)
dataSimcRatio_err_hxpfp = dataSimcRatio_hxpfp * ma.sqrt((dN_data_hms_xpfp[0]/N_data_hms_xpfp)**2 + (dN_simc_hsxpfp[0]/N_simc_hsxpfp)**2)
dataSimcRatio_err_hypfp = dataSimcRatio_hypfp * ma.sqrt((dN_data_hms_ypfp[0]/N_data_hms_ypfp)**2 + (dN_simc_hsypfp[0]/N_simc_hsypfp)**2)
dataSimcRatio_err_pxpfp = dataSimcRatio_pxpfp * ma.sqrt((dN_data_shms_xpfp[0]/N_data_shms_xpfp)**2 + (dN_simc_ssxpfp[0]/N_simc_ssxpfp)**2)
dataSimcRatio_err_pypfp = dataSimcRatio_pypfp * ma.sqrt((dN_data_shms_ypfp[0]/N_data_shms_ypfp)**2 + (dN_simc_ssypfp[0]/N_simc_ssypfp)**2)
dataSimcRatio_err_pmiss_x = dataSimcRatio_pmiss_x * ma.sqrt((dN_data_pmiss_x[0]/N_data_pmiss_x)**2 + (dN_simc_pmiss_x[0]/N_simc_pmiss_x)**2)
dataSimcRatio_err_pmiss_y = dataSimcRatio_pmiss_y * ma.sqrt((dN_data_pmiss_y[0]/N_data_pmiss_y)**2 + (dN_simc_pmiss_y[0]/N_simc_pmiss_y)**2)
dataSimcRatio_err_pmiss_z = dataSimcRatio_pmiss_z * ma.sqrt((dN_data_pmiss_z[0]/N_data_pmiss_z)**2 + (dN_simc_pmiss_z[0]/N_simc_pmiss_z)**2)
dataSimcRatio_err_pmiss = dataSimcRatio_pmiss * ma.sqrt((dN_data_pmiss[0] / N_data_pmiss)**2 + (dN_simc_pmiss[0] / N_simc_pmiss)**2)
dataSimcRatio_err_emiss = dataSimcRatio_emiss * ma.sqrt((dN_data_emiss[0]/N_data_emiss)**2 + (dN_simc_emiss[0]/N_simc_emiss)**2)
dataSimcRatio_err_W = dataSimcRatio_W * ma.sqrt((dN_data_W[0]/N_data_W)**2 + (dN_simc_W[0]/N_simc_W)**2)

print("="*40)
print("Data/SIMC ratio hdelta = {:.3f} +/- {:.3f}".format(dataSimcRatio_hdelta, dataSimcRatio_err_hdelta))
print("Data/SIMC ratio pdelta = {:.3f} +/- {:.3f}".format(dataSimcRatio_pdelta, dataSimcRatio_err_pdelta))
print("Data/SIMC ratio hxptar = {:.3f} +/- {:.3f}".format(dataSimcRatio_hxptar, dataSimcRatio_err_hxptar))
print("Data/SIMC ratio hyptar = {:.3f} +/- {:.3f}".format(dataSimcRatio_hyptar, dataSimcRatio_err_hyptar))
print("Data/SIMC ratio pxptar = {:.3f} +/- {:.3f}".format(dataSimcRatio_pxptar, dataSimcRatio_err_pxptar))
print("Data/SIMC ratio pyptar = {:.3f} +/- {:.3f}".format(dataSimcRatio_pyptar, dataSimcRatio_err_pyptar))
print("Data/SIMC ratio hxpfp = {:.3f} +/- {:.3f}".format(dataSimcRatio_hxpfp, dataSimcRatio_err_hxpfp))
print("Data/SIMC ratio hypfp = {:.3f} +/- {:.3f}".format(dataSimcRatio_hypfp, dataSimcRatio_err_hypfp))
print("Data/SIMC ratio pxpfp = {:.3f} +/- {:.3f}".format(dataSimcRatio_pxpfp, dataSimcRatio_err_pxpfp))
print("Data/SIMC ratio pypfp = {:.3f} +/- {:.3f}".format(dataSimcRatio_pypfp, dataSimcRatio_err_pypfp))
...
hsdelta_legend.AddEntry(H_hsdelta_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_hsdelta,dN_simc_error[0]), "p") # lp for liine and point
hsdelta_legend.AddEntry(H_gtr_dp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_hms_dp,dN_data_error[0]), "p")
...
psdelta_legend.AddEntry(P_ssdelta_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_ssdelta,dN_simc_error[0]), "p") # lp for liine and point
psdelta_legend.AddEntry(P_gtr_dp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_shms_dp,dN_data_error[0]), "p")
...
hxptar_legend.AddEntry(H_hsxptar_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_hsxptar,dN_simc_error[0]), "p") # lp for liine and point
hxptar_legend.AddEntry(H_gtr_xp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_hms_xp,dN_data_error[0]), "p")
...
hyptar_legend.AddEntry(H_hsyptar_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_hsyptar,dN_simc_error[0]), "p") # lp for liine and point
hyptar_legend.AddEntry(H_gtr_yp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_hms_yp,dN_data_error[0]), "p")
...
pxptar_legend.AddEntry(P_ssxptar_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_ssxptar,dN_simc_error[0]), "p") # lp for liine and point
pxptar_legend.AddEntry(P_gtr_xp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_shms_xp,dN_data_error[0]), "p")
...
pyptar_legend.AddEntry(P_ssyptar_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_ssyptar,dN_simc_error[0]), "p") # lp for liine and point
pyptar_legend.AddEntry(P_gtr_yp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_shms_yp,dN_data_error[0]), "p")
...
hxpfp_legend.AddEntry(H_hsxpfp_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_hsxpfp,dN_simc_error[0]), "p") # lp for liine and point
hxpfp_legend.AddEntry(H_dc_xp_fp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_hms_xpfp,dN_data_error[0]), "p")
...
hypfp_legend.AddEntry(H_hsypfp_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_hsypfp,dN_simc_error[0]), "p") # lp for liine and point
hypfp_legend.AddEntry(H_dc_yp_fp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_hms_ypfp,dN_data_error[0]), "p")
...
pxpfp_legend.AddEntry(P_ssxpfp_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_ssxpfp,dN_simc_error[0]), "p") # lp for liine and point
pxpfp_legend.AddEntry(P_dc_xp_fp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_shms_xpfp,dN_data_error[0]), "p")
...
pypfp_legend.AddEntry(P_ssypfp_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_ssypfp,dN_simc_error[0]), "p") # lp for liine and point
pypfp_legend.AddEntry(P_dc_yp_fp_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_shms_ypfp,dN_data_error[0]), "p")
...
pmiss_x_legend.AddEntry(pmiss_x_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_pmiss_x,dN_simc_error[0]), "p") # lp for liine and point
pmiss_x_legend.AddEntry(P_kin_secondary_pmiss_x_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_pmiss_x,dN_data_error[0]), "p")
...
pmiss_y_legend.AddEntry(pmiss_y_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_pmiss_y,dN_simc_error[0]), "p")
pmiss_y_legend.AddEntry(P_kin_secondary_pmiss_y_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_pmiss_y,dN_data_error[0]), "p")
...
pmiss_z_legend.AddEntry(pmiss_z_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_pmiss_z,dN_simc_error[0]), "p")
pmiss_z_legend.AddEntry(P_kin_secondary_pmiss_z_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_pmiss_z,dN_data_error[0]), "p")
...
pmiss_legend.AddEntry(pmiss_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_pmiss,dN_simc_error[0]), "p")
pmiss_legend.AddEntry(P_kin_secondary_pmiss_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_pmiss,dN_data_error[0]), "p")
...
emiss_legend.AddEntry(emiss_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_emiss,dN_simc_error[0]), "p")
emiss_legend.AddEntry(P_kin_secondary_emiss_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_emiss,dN_data_error[0]), "p")
...
W_legend.AddEntry(W_protons_simc_cut_all, "MC = {:.2f}+/-{:.2f}".format(N_simc_W,dN_simc_error[0]), "p")
W_legend.AddEntry(P_kin_secondary_W_protons_dummysub_data_cut_all, "Data = {:.2f}+/-{:.2f}".format(N_data_W,dN_data_error[0]), "p")

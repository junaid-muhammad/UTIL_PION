...
hsdelta_legend.AddEntry(Ratio_hsdelta,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_hdelta,dataSimcRatio_err_hdelta), "p")
hsdelta_legend.Draw()
c1_delta.cd(3)
...
psdelta_legend.AddEntry(Ratio_psdelta,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_pdelta,dataSimcRatio_err_pdelta), "p")
psdelta_legend.Draw()
c1_delta.cd(4)
...
hxptar_legend.AddEntry(Ratio_hxptar,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_hxptar,dataSimcRatio_err_hxptar), "p")
hxptar_legend.Draw()
c1_delta.cd(6)
...
hyptar_legend.AddEntry(Ratio_hyptar,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_hyptar,dataSimcRatio_err_hyptar), "p")
hyptar_legend.Draw()
...
pxptar_legend.AddEntry(Ratio_pxptar,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_pxptar,dataSimcRatio_err_pxptar), "p")
pxptar_legend.Draw()
c1_tar.cd(2)
...
pyptar_legend.AddEntry(Ratio_pyptar,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_pyptar,dataSimcRatio_err_pyptar), "p")
pyptar_legend.Draw()
c1_tar.cd(3)
...
hxpfp_legend.AddEntry(Ratio_hxpfp,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_hxpfp,dataSimcRatio_err_hxpfp), "p")
hxpfp_legend.Draw()
c1_tar.cd(4)
...
hypfp_legend.AddEntry(Ratio_hypfp,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_hypfp,dataSimcRatio_err_hypfp), "p")
hypfp_legend.Draw()
c1_tar.cd(5)
...
pxpfp_legend.AddEntry(Ratio_pxpfp,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_pxpfp,dataSimcRatio_err_pxpfp), "p")
pxpfp_legend.Draw()
c1_tar.cd(6)
...
pypfp_legend.AddEntry(Ratio_pypfp,"Ratio = {:.3f}+/-{:.3f}".format(dataSimcRatio_pypfp,dataSimcRatio_err_pypfp), "p")
pypfp_legend.Draw()

...
print('\nTotal effective charge for the data run list: {:.3f}+/-{:.3f}',total_data_effective_charge, total_data_effective_charge_error)
...
dataSimcRatio = (N_data - N_dummy) / N_simc

dataSimcRatio_err = dataSimcRatio * ma.sqrt((dN_data_error[0]/N_data)**2 + (dN_dummy_error[0]/N_dummy)**2 + (dN_simc_error[0]/N_simc)**2)

...
for index, row in filtered_data_df.iterrows():
    print('Charge for data run', {row['Run_Number']},': ',{row['BCM1_Charge']})
for index, row in filtered_dummy_df.iterrows():
    print('Charge for dummy run', {row['Run_Number']},': ',{row['BCM1_Charge']})
...
#print ('\nBeam Energy = ',BEAM_ENERGY)
print('\nTotal charge for the data run list: ',data_charge)
print('\nTotal charge for the dummy run list: ',dummy_charge)
...
H_gtr_beta_protons_data_uncut = ROOT.TH1D("H_gtr_beta_protons_data_uncut", "HMS #beta; HMS_gtr_#beta; Counts", 120, 0.8, 1.2)
H_gtr_xp_protons_data_uncut = ROOT.TH1D("H_gtr_xp_protons_data_uncut", "HMS xptar; HMS_gtr_xptar; Counts", 120, -0.2, 0.2)
H_gtr_yp_protons_data_uncut = ROOT.TH1D("H_gtr_yp_protons_data_uncut", "HMS yptar; HMS_gtr_yptar; Counts", 120, -0.2, 0.2)
H_gtr_dp_protons_data_uncut = ROOT.TH1D("H_gtr_dp_protons_data_uncut", "HMS #delta; HMS_gtr_dp; Counts", 120, -15, 15)
H_gtr_p_protons_data_uncut = ROOT.TH1D("H_gtr_p_protons_data_uncut", "HMS p; HMS_gtr_p; Counts", 120, 4, 8)
H_dc_x_fp_protons_data_uncut = ROOT.TH1D("H_dc_x_fp_protons_data_uncut", "HMS x_fp'; HMS_dc_x_fp; Counts", 120, -100, 100)
H_dc_y_fp_protons_data_uncut = ROOT.TH1D("H_dc_y_fp_protons_data_uncut", "HMS y_fp'; HMS_dc_y_fp; Counts", 120, -100, 100)
H_dc_xp_fp_protons_data_uncut = ROOT.TH1D("H_dc_xp_fp_protons_data_uncut", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
H_dc_yp_fp_protons_data_uncut = ROOT.TH1D("H_dc_yp_fp_protons_data_uncut", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
H_hod_goodscinhit_protons_data_uncut = ROOT.TH1D("H_hod_goodscinhit_protons_data_uncut", "HMS hod goodscinhit; HMS_hod_goodscinhi; Counts", 120, 0.7, 1.3)
H_hod_goodstarttime_protons_data_uncut = ROOT.TH1D("H_hod_goodstarttime_protons_data_uncut", "HMS hod goodstarttime; HMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
H_cal_etotnorm_protons_data_uncut = ROOT.TH1D("H_cal_etotnorm_protons_data_uncut", "HMS cal etotnorm; HMS_cal_etotnorm; Counts", 120, 0.2, 1.8)
H_cal_etottracknorm_protons_data_uncut = ROOT.TH1D("H_cal_etottracknorm_protons_data_uncut", "HMS cal etottracknorm; HMS_cal_etottracknorm; Counts", 300, 0.2, 1.8)
H_cer_npeSum_protons_data_uncut = ROOT.TH1D("H_cer_npeSum_protons_data_uncut", "HMS cer npeSum; HMS_cer_npeSum; Counts", 120, 0, 50)
H_RFTime_Dist_protons_data_uncut = ROOT.TH1D("H_RFTime_Dist_protons_data_uncut", "HMS RFTime; HMS_RFTime; Counts", 120, 0, 4)
P_gtr_beta_protons_data_uncut = ROOT.TH1D("P_gtr_beta_protons_data_uncut", "SHMS #beta; SHMS_gtr_#beta; Counts", 120, 0.5, 1.3)
P_gtr_xp_protons_data_uncut = ROOT.TH1D("P_gtr_xp_protons_data_uncut", "SHMS xptar; SHMS_gtr_xptar; Counts", 120, -0.2, 0.2)
P_gtr_yp_protons_data_uncut = ROOT.TH1D("P_gtr_yp_protons_data_uncut", "SHMS yptar; SHMS_gtr_yptar; Counts", 120, -0.2, 0.2)
P_gtr_dp_protons_data_uncut = ROOT.TH1D("P_gtr_dp_protons_data_uncut", "SHMS delta; SHMS_gtr_dp; Counts", 120, -30, 30)
P_gtr_p_protons_data_uncut = ROOT.TH1D("P_gtr_p_protons_data_uncut", "SHMS p; SHMS_gtr_p; Counts", 120, 1, 7)
P_dc_x_fp_protons_data_uncut = ROOT.TH1D("P_dc_x_fp_protons_data_uncut", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 120, -100, 100)
P_dc_y_fp_protons_data_uncut = ROOT.TH1D("P_dc_y_fp_protons_data_uncut", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 120, -100, 100)
P_dc_xp_fp_protons_data_uncut = ROOT.TH1D("P_dc_xp_fp_protons_data_uncut", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
P_dc_yp_fp_protons_data_uncut = ROOT.TH1D("P_dc_yp_fp_protons_data_uncut", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
P_hod_goodscinhit_protons_data_uncut = ROOT.TH1D("P_hod_goodscinhit_protons_data_uncut", "SHMS hod goodscinhit; SHMS_hod_goodscinhit; Counts", 120, 0.7, 1.3)
P_hod_goodstarttime_protons_data_uncut = ROOT.TH1D("P_hod_goodstarttime_protons_data_uncut", "SHMS hod goodstarttime; SHMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
P_cal_etotnorm_protons_data_uncut = ROOT.TH1D("P_cal_etotnorm_protons_data_uncut", "SHMS cal etotnorm; SHMS_cal_etotnorm; Counts", 120, 0, 1)
P_cal_etottracknorm_protons_data_uncut = ROOT.TH1D("P_cal_etottracknorm_protons_data_uncut", "SHMS cal etottracknorm; SHMS_cal_etottracknorm; Counts", 120, 0, 1.6)
P_hgcer_npeSum_protons_data_uncut = ROOT.TH1D("P_hgcer_npeSum_protons_data_uncut", "SHMS HGC npeSum; SHMS_hgcer_npeSum; Counts", 120, 0, 50)
P_hgcer_xAtCer_protons_data_uncut = ROOT.TH1D("P_hgcer_xAtCer_protons_data_uncut", "SHMS HGC xAtCer; SHMS_hgcer_xAtCer; Counts", 120, -60, 60)
P_hgcer_yAtCer_protons_data_uncut = ROOT.TH1D("P_hgcer_yAtCer_protons_data_uncut", "SHMS HGC yAtCer; SHMS_hgcer_yAtCer; Counts", 120, -50, 50)
P_ngcer_npeSum_protons_data_uncut = ROOT.TH1D("P_ngcer_npeSum_protons_data_uncut", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 120, 0, 50)
P_ngcer_xAtCer_protons_data_uncut = ROOT.TH1D("P_ngcer_xAtCer_protons_data_uncut", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", 120, -60, 60)
P_ngcer_yAtCer_protons_data_uncut = ROOT.TH1D("P_ngcer_yAtCer_protons_data_uncut", "SHMS NGC yAtCer; SHMS_ngcer_yAtCer; Counts", 120, -50, 50)
P_aero_npeSum_protons_data_uncut = ROOT.TH1D("P_aero_npeSum_protons_data_uncut", "SHMS aero npeSum; SHMS_aero_npeSum; Counts", 120, 0, 50)
P_aero_xAtAero_protons_data_uncut = ROOT.TH1D("P_acero_xAtAero_protons_data_uncut", "SHMS aero xAtAero; SHMS_aero_xAtAero; Counts", 120, -60, 60)
P_aero_yAtAero_protons_data_uncut = ROOT.TH1D("P_aero_yAtAero_protons_data_uncut", "SHMS aero yAtAero; SHMS_aero_yAtAero; Counts", 120, -50, 50)
P_kin_MMp_protons_data_uncut = ROOT.TH1D("P_kin_MMp_protons_data_uncut", "MIssing Mass data uncut; MM_{p}; Counts", 120, -1., 1.)
P_RFTime_Dist_protons_data_uncut = ROOT.TH1D("P_RFTime_Dist_protons_data_uncut", "SHMS RFTime; SHMS_RFTime; Counts", 120, 0, 4)
CTime_epCoinTime_ROC1_protons_data_uncut = ROOT.TH1D("CTime_epCoinTime_ROC1_protons_data_uncut", "Electron-Proton CTime; e p Coin_Time; Counts", 120, -50, 50)
P_kin_secondary_pmiss_protons_data_uncut = ROOT.TH1D("P_kin_secondary_pmiss_protons_data_uncut", "Momentum Distribution; pmiss; Counts", 120, -0.8, 0.8)
P_kin_secondary_pmiss_x_protons_data_uncut = ROOT.TH1D("P_kin_secondary_pmiss_x_protons_data_uncut", "Momentum_x Distribution; pmiss_x; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_y_protons_data_uncut = ROOT.TH1D("P_kin_secondary_pmiss_y_protons_data_uncut", "Momentum_y Distribution; pmiss_y; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_z_protons_data_uncut = ROOT.TH1D("P_kin_secondary_pmiss_z_protons_data_uncut", "Momentum_z Distribution; pmiss_z; Counts", 120, -0.6, 0.6)
P_kin_secondary_Erecoil_protons_data_uncut = ROOT.TH1D("P_kin_secondary_Erecoil_protons_data_uncut", "Erecoil Distribution; Erecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_data_uncut = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_data_uncut", "Emiss Distribution; emiss_nuc; Counts", 120, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_data_uncut = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_data_uncut", "Mrecoil Distribution; Mrecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_W_protons_data_uncut = ROOT.TH1D("P_kin_secondary_W_protons_data_uncut", "W Distribution; W; Counts", 120, 0, 2)

# Cut (Acceptance + PID) Data Histograms
H_gtr_beta_protons_data_cut_all = ROOT.TH1D("H_gtr_beta_protons_data_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", 120, 0.8, 1.2)
H_gtr_xp_protons_data_cut_all = ROOT.TH1D("H_gtr_xp_protons_data_cut_all", "HMS xptar; HMS_gtr_xptar; Counts", 120, -0.2, 0.2)
H_gtr_yp_protons_data_cut_all = ROOT.TH1D("H_gtr_yp_protons_data_cut_all", "HMS yptar; HMS_gtr_yptar; Counts", 120, -0.2, 0.2)
H_gtr_dp_protons_data_cut_all = ROOT.TH1D("H_gtr_dp_protons_data_cut_all", "HMS #delta; HMS_gtr_dp; Counts", 120, -15, 15)
H_gtr_p_protons_data_cut_all = ROOT.TH1D("H_gtr_p_protons_data_cut_all", "HMS p; HMS_gtr_p; Counts", 120, 4, 8)
H_dc_x_fp_protons_data_cut_all = ROOT.TH1D("H_dc_x_fp_protons_data_cut_all", "HMS x_fp'; HMS_dc_x_fp; Counts", 120, -100, 100)
H_dc_y_fp_protons_data_cut_all = ROOT.TH1D("H_dc_y_fp_protons_data_cut_all", "HMS y_fp'; HMS_dc_y_fp; Counts", 120, -100, 100)
H_dc_xp_fp_protons_data_cut_all = ROOT.TH1D("H_dc_xp_fp_protons_data_cut_all", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
H_dc_yp_fp_protons_data_cut_all = ROOT.TH1D("H_dc_yp_fp_protons_data_cut_all", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
H_hod_goodscinhit_protons_data_cut_all = ROOT.TH1D("H_hod_goodscinhit_protons_data_cut_all", "HMS hod goodscinhit; HMS_hod_goodscinhi; Counts", 120, 0.7, 1.3)
H_hod_goodstarttime_protons_data_cut_all = ROOT.TH1D("H_hod_goodstarttime_protons_data_cut_all", "HMS hod goodstarttime; HMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
H_cal_etotnorm_protons_data_cut_all = ROOT.TH1D("H_cal_etotnorm_protons_data_cut_all", "HMS cal etotnorm; HMS_cal_etotnorm; Counts", 120, 0.2, 1.8)
H_cal_etottracknorm_protons_data_cut_all = ROOT.TH1D("H_cal_etottracknorm_protons_data_cut_all", "HMS cal etottracknorm; HMS_cal_etottracknorm; Counts", 300, 0.2, 1.8)
H_cer_npeSum_protons_data_cut_all = ROOT.TH1D("H_cer_npeSum_protons_data_cut_all", "HMS cer npeSum; HMS_cer_npeSum; Counts", 120, 0, 50)
H_RFTime_Dist_protons_data_cut_all = ROOT.TH1D("H_RFTime_Dist_protons_data_cut_all", "HMS RFTime; HMS_RFTime; Counts", 120, 0, 4)
P_gtr_beta_protons_data_cut_all = ROOT.TH1D("P_gtr_beta_protons_data_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", 120, 0.5, 1.3)
P_gtr_xp_protons_data_cut_all = ROOT.TH1D("P_gtr_xp_protons_data_cut_all", "SHMS xptar; SHMS_gtr_xptar; Counts", 120, -0.2, 0.2)
P_gtr_yp_protons_data_cut_all = ROOT.TH1D("P_gtr_yp_protons_data_cut_all", "SHMS yptar; SHMS_gtr_yptar; Counts", 120, -0.2, 0.2)
P_gtr_dp_protons_data_cut_all = ROOT.TH1D("P_gtr_dp_protons_data_cut_all", "SHMS delta; SHMS_gtr_dp; Counts", 120, -30, 30)
P_gtr_p_protons_data_cut_all = ROOT.TH1D("P_gtr_p_protons_data_cut_all", "SHMS p; SHMS_gtr_p; Counts", 120, 1, 7)
P_dc_x_fp_protons_data_cut_all = ROOT.TH1D("P_dc_x_fp_protons_data_cut_all", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 120, -100, 100)
P_dc_y_fp_protons_data_cut_all = ROOT.TH1D("P_dc_y_fp_protons_data_cut_all", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 120, -100, 100)
P_dc_xp_fp_protons_data_cut_all = ROOT.TH1D("P_dc_xp_fp_protons_data_cut_all", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
P_dc_yp_fp_protons_data_cut_all = ROOT.TH1D("P_dc_yp_fp_protons_data_cut_all", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
P_hod_goodscinhit_protons_data_cut_all = ROOT.TH1D("P_hod_goodscinhit_protons_data_cut_all", "SHMS hod goodscinhit; SHMS_hod_goodscinhit; Counts", 120, 0.7, 1.3)
P_hod_goodstarttime_protons_data_cut_all = ROOT.TH1D("P_hod_goodstarttime_protons_data_cut_all", "SHMS hod goodstarttime; SHMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
P_cal_etotnorm_protons_data_cut_all = ROOT.TH1D("P_cal_etotnorm_protons_data_cut_all", "SHMS cal etotnorm; SHMS_cal_etotnorm; Counts", 120, 0, 1)
P_cal_etottracknorm_protons_data_cut_all = ROOT.TH1D("P_cal_etottracknorm_protons_data_cut_all", "SHMS cal etottracknorm; SHMS_cal_etottracknorm; Counts", 120, 0, 1.6)
P_hgcer_npeSum_protons_data_cut_all = ROOT.TH1D("P_hgcer_npeSum_protons_data_cut_all", "SHMS HGC npeSum; SHMS_hgcer_npeSum; Counts", 120, 0, 50)
P_hgcer_xAtCer_protons_data_cut_all = ROOT.TH1D("P_hgcer_xAtCer_protons_data_cut_all", "SHMS HGC xAtCer; SHMS_hgcer_xAtCer; Counts", 120, -60, 60)
P_hgcer_yAtCer_protons_data_cut_all = ROOT.TH1D("P_hgcer_yAtCer_protons_data_cut_all", "SHMS HGC yAtCer; SHMS_hgcer_yAtCer; Counts", 120, -50, 50)
P_ngcer_npeSum_protons_data_cut_all = ROOT.TH1D("P_ngcer_npeSum_protons_data_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 120, 0, 50)
P_ngcer_xAtCer_protons_data_cut_all = ROOT.TH1D("P_ngcer_xAtCer_protons_data_cut_all", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", 120, -60, 60)
P_ngcer_yAtCer_protons_data_cut_all = ROOT.TH1D("P_ngcer_yAtCer_protons_data_cut_all", "SHMS NGC yAtCer; SHMS_ngcer_yAtCer; Counts", 120, -50, 50)
P_aero_npeSum_protons_data_cut_all = ROOT.TH1D("P_aero_npeSum_protons_data_cut_all", "SHMS aero npeSum; SHMS_aero_npeSum; Counts", 120, 0, 50)
P_aero_xAtAero_protons_data_cut_all = ROOT.TH1D("P_acero_xAtAero_protons_data_cut_all", "SHMS aero xAtAero; SHMS_aero_xAtAero; Counts", 120, -60, 60)
P_aero_yAtAero_protons_data_cut_all = ROOT.TH1D("P_aero_yAtAero_protons_data_cut_all", "SHMS aero yAtAero; SHMS_aero_yAtAero; Counts", 120, -50, 50)
P_kin_MMp_protons_data_cut_all = ROOT.TH1D("P_kin_MMp_protons_data_cut_all", "MIssing Mass data (cut_all); MM_{p}; Counts", 120, -1., 1.)
P_RFTime_Dist_protons_data_cut_all = ROOT.TH1D("P_RFTime_Dist_protons_data_cut_all", "SHMS RFTime; SHMS_RFTime; Counts", 120, 0, 4)
CTime_epCoinTime_ROC1_protons_data_cut_all = ROOT.TH1D("CTime_epCoinTime_ROC1_protons_data_cut_all", "Electron-Proton CTime; e p Coin_Time; Counts", 120, -50, 50)
P_kin_secondary_pmiss_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_protons_data_cut_all", "Momentum Distribution; pmiss; Counts", 120, -0.8, 0.8)
P_kin_secondary_pmiss_x_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_x_protons_data_cut_all", "Momentum_x Distribution; pmiss_x; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_y_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_y_protons_data_cut_all", "Momentum_y Distribution; pmiss_y; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_z_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_z_protons_data_cut_all", "Momentum_z Distribution; pmiss_z; Counts", 120, -0.6, 0.6)
P_kin_secondary_Erecoil_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_Erecoil_protons_data_cut_all", "Erecoil Distribution; Erecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_data_cut_all", "Energy Distribution; emiss_nuc; Counts", 120, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_data_cut_all", "Mrecoil Distribution; Mrecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_W_protons_data_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_data_cut_all", "W Distribution; W; Counts", 120, 0, 2)

# Cut (Acceptance + PID + Prompt Selection) Data Histograms
H_gtr_beta_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_beta_protons_data_prompt_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", 120, 0.8, 1.2)
H_gtr_xp_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_xp_protons_data_prompt_cut_all", "HMS xptar; HMS_gtr_xptar; Counts", 120, -0.2, 0.2)
H_gtr_yp_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_yp_protons_data_prompt_cut_all", "HMS yptar; HMS_gtr_yptar; Counts", 120, -0.2, 0.2)
H_gtr_dp_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_dp_protons_data_prompt_cut_all", "HMS #delta; HMS_gtr_dp; Counts", 120, -15, 15)
H_gtr_p_protons_data_prompt_cut_all = ROOT.TH1D("H_gtr_p_protons_data_prompt_cut_all", "HMS p; HMS_gtr_p; Counts", 120, 4, 8)
H_dc_x_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_x_fp_protons_data_prompt_cut_all", "HMS x_fp'; HMS_dc_x_fp; Counts", 120, -100, 100)
H_dc_y_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_y_fp_protons_data_prompt_cut_all", "HMS y_fp'; HMS_dc_y_fp; Counts", 120, -100, 100)
H_dc_xp_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_xp_fp_protons_data_prompt_cut_all", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
H_dc_yp_fp_protons_data_prompt_cut_all = ROOT.TH1D("H_dc_yp_fp_protons_data_prompt_cut_all", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
H_hod_goodscinhit_protons_data_prompt_cut_all = ROOT.TH1D("H_hod_goodscinhit_protons_data_prompt_cut_all", "HMS hod goodscinhit; HMS_hod_goodscinhi; Counts", 120, 0.7, 1.3)
H_hod_goodstarttime_protons_data_prompt_cut_all = ROOT.TH1D("H_hod_goodstarttime_protons_data_prompt_cut_all", "HMS hod goodstarttime; HMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
H_cal_etotnorm_protons_data_prompt_cut_all = ROOT.TH1D("H_cal_etotnorm_protons_data_prompt_cut_all", "HMS cal etotnorm; HMS_cal_etotnorm; Counts", 120, 0.2, 1.8)
H_cal_etottracknorm_protons_data_prompt_cut_all = ROOT.TH1D("H_cal_etottracknorm_protons_data_prompt_cut_all", "HMS cal etottracknorm; HMS_cal_etottracknorm; Counts", 300, 0.2, 1.8)
H_cer_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("H_cer_npeSum_protons_data_prompt_cut_all", "HMS cer npeSum; HMS_cer_npeSum; Counts", 120, 0, 50)
H_RFTime_Dist_protons_data_prompt_cut_all = ROOT.TH1D("H_RFTime_Dist_protons_data_prompt_cut_all", "HMS RFTime; HMS_RFTime; Counts", 120, 0, 4)
P_gtr_beta_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_beta_protons_data_prompt_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", 120, 0.5, 1.3)
P_gtr_xp_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_xp_protons_data_prompt_cut_all", "SHMS xptar; SHMS_gtr_xptar; Counts", 120, -0.2, 0.2)
P_gtr_yp_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_yp_protons_data_prompt_cut_all", "SHMS yptar; SHMS_gtr_yptar; Counts", 120, -0.2, 0.2)
P_gtr_dp_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_dp_protons_data_prompt_cut_all", "SHMS delta; SHMS_gtr_dp; Counts", 120, -30, 30)
P_gtr_p_protons_data_prompt_cut_all = ROOT.TH1D("P_gtr_p_protons_data_prompt_cut_all", "SHMS p; SHMS_gtr_p; Counts", 120, 1, 7)
P_dc_x_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_x_fp_protons_data_prompt_cut_all", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 120, -100, 100)
P_dc_y_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_y_fp_protons_data_prompt_cut_all", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 120, -100, 100)
P_dc_xp_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_xp_fp_protons_data_prompt_cut_all", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
P_dc_yp_fp_protons_data_prompt_cut_all = ROOT.TH1D("P_dc_yp_fp_protons_data_prompt_cut_all", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
P_hod_goodscinhit_protons_data_prompt_cut_all = ROOT.TH1D("P_hod_goodscinhit_protons_data_prompt_cut_all", "SHMS hod goodscinhit; SHMS_hod_goodscinhit; Counts", 120, 0.7, 1.3)
P_hod_goodstarttime_protons_data_prompt_cut_all = ROOT.TH1D("P_hod_goodstarttime_protons_data_prompt_cut_all", "SHMS hod goodstarttime; SHMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
P_cal_etotnorm_protons_data_prompt_cut_all = ROOT.TH1D("P_cal_etotnorm_protons_data_prompt_cut_all", "SHMS cal etotnorm; SHMS_cal_etotnorm; Counts", 120, 0, 1)
P_cal_etottracknorm_protons_data_prompt_cut_all = ROOT.TH1D("P_cal_etottracknorm_protons_data_prompt_cut_all", "SHMS cal etottracknorm; SHMS_cal_etottracknorm; Counts", 120, 0, 1.6)
P_hgcer_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("P_hgcer_npeSum_protons_data_prompt_cut_all", "SHMS HGC npeSum; SHMS_hgcer_npeSum; Counts", 120, 0, 50)
P_hgcer_xAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_hgcer_xAtCer_protons_data_prompt_cut_all", "SHMS HGC xAtCer; SHMS_hgcer_xAtCer; Counts", 120, -60, 60)
P_hgcer_yAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_hgcer_yAtCer_protons_data_prompt_cut_all", "SHMS HGC yAtCer; SHMS_hgcer_yAtCer; Counts", 120, -50, 50)
P_ngcer_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("P_ngcer_npeSum_protons_data_prompt_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 120, 0, 50)
P_ngcer_xAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_ngcer_xAtCer_protons_data_prompt_cut_all", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", 120, -60, 60)
P_ngcer_yAtCer_protons_data_prompt_cut_all = ROOT.TH1D("P_ngcer_yAtCer_protons_data_prompt_cut_all", "SHMS NGC yAtCer; SHMS_ngcer_yAtCer; Counts", 120, -50, 50)
P_aero_npeSum_protons_data_prompt_cut_all = ROOT.TH1D("P_aero_npeSum_protons_data_prompt_cut_all", "SHMS aero npeSum; SHMS_aero_npeSum; Counts", 120, 0, 50)
P_aero_xAtAero_protons_data_prompt_cut_all = ROOT.TH1D("P_acero_xAtAero_protons_data_prompt_cut_all", "SHMS aero xAtAero; SHMS_aero_xAtAero; Counts", 120, -60, 60)
P_aero_yAtAero_protons_data_prompt_cut_all = ROOT.TH1D("P_aero_yAtAero_protons_data_prompt_cut_all", "SHMS aero yAtAero; SHMS_aero_yAtAero; Counts", 120, -50, 50)
P_kin_MMp_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_MMp_protons_data_prompt_cut_all", "MIssing Mass data (prompt_cut_all); MM_{p}; Counts", 120, -1., 1.)
P_RFTime_Dist_protons_data_prompt_cut_all = ROOT.TH1D("P_RFTime_Dist_protons_data_prompt_cut_all", "SHMS RFTime; SHMS_RFTime; Counts", 120, 0, 4)
CTime_epCoinTime_ROC1_protons_data_prompt_cut_all = ROOT.TH1D("CTime_epCoinTime_ROC1_protons_data_prompt_cut_all", "Electron-Proton CTime; e p Coin_Time; Counts", 120, -50, 50)
P_kin_secondary_pmiss_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_protons_data_prompt_cut_all", "Momentum Distribution; pmiss; Counts", 120, -0.8, 0.8)
P_kin_secondary_pmiss_x_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_x_protons_data_prompt_cut_all", "Momentum_x Distribution; pmiss_x; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_y_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_y_protons_data_prompt_cut_all", "Momentum_y Distribution; pmiss_y; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_z_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_z_protons_data_prompt_cut_all", "Momentum_z Distribution; pmiss_z; Counts", 120, -0.6, 0.6)
P_kin_secondary_Erecoil_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Erecoil_protons_data_prompt_cut_all", "Erecoil Distribution; Erecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_data_prompt_cut_all", "Energy Distribution; emiss_nuc; Counts", 120, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_data_prompt_cut_all", "Mrecoil Distribution; Mrecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_W_protons_data_prompt_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_data_prompt_cut_all", "W Distribution; W; Counts", 120, 0, 2)
MMsquared_data_prompt_cut_all = ROOT.TH1D("MMsquared_data_prompt_cut_all", "Missing Mass Squared; MM^{2}_{p}; Counts", 120, -1., 1.)

# Cut (Acceptance + PID + Prompt Selection) Dummy Histograms
H_gtr_beta_protons_dummy_prompt_cut_all = ROOT.TH1D("H_gtr_beta_protons_dummy_prompt_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", 120, 0.8, 1.2)
H_gtr_xp_protons_dummy_prompt_cut_all = ROOT.TH1D("H_gtr_xp_protons_dummy_prompt_cut_all", "HMS xptar; HMS_gtr_xptar; Counts", 120, -0.2, 0.2)
H_gtr_yp_protons_dummy_prompt_cut_all = ROOT.TH1D("H_gtr_yp_protons_dummy_prompt_cut_all", "HMS yptar; HMS_gtr_yptar; Counts", 120, -0.2, 0.2)
H_gtr_dp_protons_dummy_prompt_cut_all = ROOT.TH1D("H_gtr_dp_protons_dummy_prompt_cut_all", "HMS #delta; HMS_gtr_dp; Counts", 120, -15, 15)
H_gtr_p_protons_dummy_prompt_cut_all = ROOT.TH1D("H_gtr_p_protons_dummy_prompt_cut_all", "HMS p; HMS_gtr_p; Counts", 120, 4, 8)
H_dc_x_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("H_dc_x_fp_protons_dummy_prompt_cut_all", "HMS x_fp'; HMS_dc_x_fp; Counts", 120, -100, 100)
H_dc_y_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("H_dc_y_fp_protons_dummy_prompt_cut_all", "HMS y_fp'; HMS_dc_y_fp; Counts", 120, -100, 100)
H_dc_xp_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("H_dc_xp_fp_protons_dummy_prompt_cut_all", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
H_dc_yp_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("H_dc_yp_fp_protons_dummy_prompt_cut_all", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
H_hod_goodscinhit_protons_dummy_prompt_cut_all = ROOT.TH1D("H_hod_goodscinhit_protons_dummy_prompt_cut_all", "HMS hod goodscinhit; HMS_hod_goodscinhi; Counts", 120, 0.7, 1.3)
H_hod_goodstarttime_protons_dummy_prompt_cut_all = ROOT.TH1D("H_hod_goodstarttime_protons_dummy_prompt_cut_all", "HMS hod goodstarttime; HMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
H_cal_etotnorm_protons_dummy_prompt_cut_all = ROOT.TH1D("H_cal_etotnorm_protons_dummy_prompt_cut_all", "HMS cal etotnorm; HMS_cal_etotnorm; Counts", 120, 0.2, 1.8)
H_cal_etottracknorm_protons_dummy_prompt_cut_all = ROOT.TH1D("H_cal_etottracknorm_protons_dummy_prompt_cut_all", "HMS cal etottracknorm; HMS_cal_etottracknorm; Counts", 300, 0.2, 1.8)
H_cer_npeSum_protons_dummy_prompt_cut_all = ROOT.TH1D("H_cer_npeSum_protons_dummy_prompt_cut_all", "HMS cer npeSum; HMS_cer_npeSum; Counts", 120, 0, 50)
H_RFTime_Dist_protons_dummy_prompt_cut_all = ROOT.TH1D("H_RFTime_Dist_protons_dummy_prompt_cut_all", "HMS RFTime; HMS_RFTime; Counts", 120, 0, 4)
P_gtr_beta_protons_dummy_prompt_cut_all = ROOT.TH1D("P_gtr_beta_protons_dummy_prompt_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", 120, 0.5, 1.3)
P_gtr_xp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_gtr_xp_protons_dummy_prompt_cut_all", "SHMS xptar; SHMS_gtr_xptar; Counts", 120, -0.2, 0.2)
P_gtr_yp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_gtr_yp_protons_dummy_prompt_cut_all", "SHMS yptar; SHMS_gtr_yptar; Counts", 120, -0.2, 0.2)
P_gtr_dp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_gtr_dp_protons_dummy_prompt_cut_all", "SHMS delta; SHMS_gtr_dp; Counts", 120, -30, 30)
P_gtr_p_protons_dummy_prompt_cut_all = ROOT.TH1D("P_gtr_p_protons_dummy_prompt_cut_all", "SHMS p; SHMS_gtr_p; Counts", 120, 1, 7)
P_dc_x_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_dc_x_fp_protons_dummy_prompt_cut_all", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 120, -100, 100)
P_dc_y_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_dc_y_fp_protons_dummy_prompt_cut_all", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 120, -100, 100)
P_dc_xp_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_dc_xp_fp_protons_dummy_prompt_cut_all", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
P_dc_yp_fp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_dc_yp_fp_protons_dummy_prompt_cut_all", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
P_hod_goodscinhit_protons_dummy_prompt_cut_all = ROOT.TH1D("P_hod_goodscinhit_protons_dummy_prompt_cut_all", "SHMS hod goodscinhit; SHMS_hod_goodscinhit; Counts", 120, 0.7, 1.3)
P_hod_goodstarttime_protons_dummy_prompt_cut_all = ROOT.TH1D("P_hod_goodstarttime_protons_dummy_prompt_cut_all", "SHMS hod goodstarttime; SHMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
P_cal_etotnorm_protons_dummy_prompt_cut_all = ROOT.TH1D("P_cal_etotnorm_protons_dummy_prompt_cut_all", "SHMS cal etotnorm; SHMS_cal_etotnorm; Counts", 120, 0, 1)
P_cal_etottracknorm_protons_dummy_prompt_cut_all = ROOT.TH1D("P_cal_etottracknorm_protons_dummy_prompt_cut_all", "SHMS cal etottracknorm; SHMS_cal_etottracknorm; Counts", 120, 0, 1.6)
P_hgcer_npeSum_protons_dummy_prompt_cut_all = ROOT.TH1D("P_hgcer_npeSum_protons_dummy_prompt_cut_all", "SHMS HGC npeSum; SHMS_hgcer_npeSum; Counts", 120, 0, 50)
P_hgcer_xAtCer_protons_dummy_prompt_cut_all = ROOT.TH1D("P_hgcer_xAtCer_protons_dummy_prompt_cut_all", "SHMS HGC xAtCer; SHMS_hgcer_xAtCer; Counts", 120, -60, 60)
P_hgcer_yAtCer_protons_dummy_prompt_cut_all = ROOT.TH1D("P_hgcer_yAtCer_protons_dummy_prompt_cut_all", "SHMS HGC yAtCer; SHMS_hgcer_yAtCer; Counts", 120, -50, 50)
P_ngcer_npeSum_protons_dummy_prompt_cut_all = ROOT.TH1D("P_ngcer_npeSum_protons_dummy_prompt_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 120, 0, 50)
P_ngcer_xAtCer_protons_dummy_prompt_cut_all = ROOT.TH1D("P_ngcer_xAtCer_protons_dummy_prompt_cut_all", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", 120, -60, 60)
P_ngcer_yAtCer_protons_dummy_prompt_cut_all = ROOT.TH1D("P_ngcer_yAtCer_protons_dummy_prompt_cut_all", "SHMS NGC yAtCer; SHMS_ngcer_yAtCer; Counts", 120, -50, 50)
P_aero_npeSum_protons_dummy_prompt_cut_all = ROOT.TH1D("P_aero_npeSum_protons_dummy_prompt_cut_all", "SHMS aero npeSum; SHMS_aero_npeSum; Counts", 120, 0, 50)
P_aero_xAtAero_protons_dummy_prompt_cut_all = ROOT.TH1D("P_acero_xAtAero_protons_dummy_prompt_cut_all", "SHMS aero xAtAero; SHMS_aero_xAtAero; Counts", 120, -60, 60)
P_aero_yAtAero_protons_dummy_prompt_cut_all = ROOT.TH1D("P_aero_yAtAero_protons_dummy_prompt_cut_all", "SHMS aero yAtAero; SHMS_aero_yAtAero; Counts", 120, -50, 50)
P_kin_MMp_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_MMp_protons_dummy_prompt_cut_all", "MIssing Mass dummy (prompt_cut_all); MM_{p}; Counts", 120, -1., 1.)
P_RFTime_Dist_protons_dummy_prompt_cut_all = ROOT.TH1D("P_RFTime_Dist_protons_dummy_prompt_cut_all", "SHMS RFTime; SHMS_RFTime; Counts", 120, 0, 4)
CTime_epCoinTime_ROC1_protons_dummy_prompt_cut_all = ROOT.TH1D("CTime_epCoinTime_ROC1_protons_dummy_prompt_cut_all", "Electron-Proton CTime; e p Coin_Time; Counts", 120, -50, 50)
P_kin_secondary_pmiss_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_protons_dummy_prompt_cut_all", "Momentum Distribution; pmiss; Counts", 120, -0.8, 0.8)
P_kin_secondary_pmiss_x_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_x_protons_dummy_prompt_cut_all", "Momentum_x Distribution; pmiss_x; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_y_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_y_protons_dummy_prompt_cut_all", "Momentum_y Distribution; pmiss_y; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_z_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_z_protons_dummy_prompt_cut_all", "Momentum_z Distribution; pmiss_z; Counts", 120, -0.6, 0.6)
P_kin_secondary_Erecoil_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Erecoil_protons_dummy_prompt_cut_all", "Erecoil Distribution; Erecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_dummy_prompt_cut_all", "Energy Distribution; emiss_nuc; Counts", 120, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_dummy_prompt_cut_all", "Mrecoil Distribution; Mrecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_W_protons_dummy_prompt_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_dummy_prompt_cut_all", "W Distribution; W; Counts", 120, 0, 2)
MMsquared_dummy_prompt_cut_all = ROOT.TH1D("MMsquared_dummy_prompt_cut_all", "Missing Mass Squared; MM^{2}_{p}; Counts", 120, -1., 1.)

# Dummy Subtracted Data Histograms
H_gtr_beta_protons_dummysub_data_cut_all = ROOT.TH1D("H_gtr_beta_protons_dummysub_data_cut_all", "HMS #beta; HMS_gtr_#beta; Counts", 120, 0.8, 1.2)
H_gtr_xp_protons_dummysub_data_cut_all = ROOT.TH1D("H_gtr_xp_protons_dummysub_data_cut_all", "HMS xptar; HMS_gtr_xptar; Counts", 120, -0.2, 0.2)
H_gtr_yp_protons_dummysub_data_cut_all = ROOT.TH1D("H_gtr_yp_protons_dummysub_data_cut_all", "HMS yptar; HMS_gtr_yptar; Counts", 120, -0.2, 0.2)
H_gtr_dp_protons_dummysub_data_cut_all = ROOT.TH1D("H_gtr_dp_protons_dummysub_data_cut_all", "HMS #delta; HMS_gtr_dp; Counts", 120, -15, 15)
H_gtr_p_protons_dummysub_data_cut_all = ROOT.TH1D("H_gtr_p_protons_dummysub_data_cut_all", "HMS p; HMS_gtr_p; Counts", 120, 4, 8)
H_dc_x_fp_protons_dummysub_data_cut_all = ROOT.TH1D("H_dc_x_fp_protons_dummysub_data_cut_all", "HMS x_fp'; HMS_dc_x_fp; Counts", 120, -100, 100)
H_dc_y_fp_protons_dummysub_data_cut_all = ROOT.TH1D("H_dc_y_fp_protons_dummysub_data_cut_all", "HMS y_fp'; HMS_dc_y_fp; Counts", 120, -100, 100)
H_dc_xp_fp_protons_dummysub_data_cut_all = ROOT.TH1D("H_dc_xp_fp_protons_dummysub_data_cut_all", "HMS xp_fp'; HMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
H_dc_yp_fp_protons_dummysub_data_cut_all = ROOT.TH1D("H_dc_yp_fp_protons_dummysub_data_cut_all", "HMS yp_fp'; HMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
H_hod_goodscinhit_protons_dummysub_data_cut_all = ROOT.TH1D("H_hod_goodscinhit_protons_dummysub_data_cut_all", "HMS hod goodscinhit; HMS_hod_goodscinhi; Counts", 120, 0.7, 1.3)
H_hod_goodstarttime_protons_dummysub_data_cut_all = ROOT.TH1D("H_hod_goodstarttime_protons_dummysub_data_cut_all", "HMS hod goodstarttime; HMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
H_cal_etotnorm_protons_dummysub_data_cut_all = ROOT.TH1D("H_cal_etotnorm_protons_dummysub_data_cut_all", "HMS cal etotnorm; HMS_cal_etotnorm; Counts", 120, 0.2, 1.8)
H_cal_etottracknorm_protons_dummysub_data_cut_all = ROOT.TH1D("H_cal_etottracknorm_protons_dummysub_data_cut_all", "HMS cal etottracknorm; HMS_cal_etottracknorm; Counts", 300, 0.2, 1.8)
H_cer_npeSum_protons_dummysub_data_cut_all = ROOT.TH1D("H_cer_npeSum_protons_dummysub_data_cut_all", "HMS cer npeSum; HMS_cer_npeSum; Counts", 120, 0, 50)
H_RFTime_Dist_protons_dummysub_data_cut_all = ROOT.TH1D("H_RFTime_Dist_protons_dummysub_data_cut_all", "HMS RFTime; HMS_RFTime; Counts", 120, 0, 4)
P_gtr_beta_protons_dummysub_data_cut_all = ROOT.TH1D("P_gtr_beta_protons_dummysub_data_cut_all", "SHMS #beta; SHMS_gtr_#beta; Counts", 120, 0.5, 1.3)
P_gtr_xp_protons_dummysub_data_cut_all = ROOT.TH1D("P_gtr_xp_protons_dummysub_data_cut_all", "SHMS xptar; SHMS_gtr_xptar; Counts", 120, -0.2, 0.2)
P_gtr_yp_protons_dummysub_data_cut_all = ROOT.TH1D("P_gtr_yp_protons_dummysub_data_cut_all", "SHMS yptar; SHMS_gtr_yptar; Counts", 120, -0.2, 0.2)
P_gtr_dp_protons_dummysub_data_cut_all = ROOT.TH1D("P_gtr_dp_protons_dummysub_data_cut_all", "SHMS delta; SHMS_gtr_dp; Counts", 120, -30, 30)
P_gtr_p_protons_dummysub_data_cut_all = ROOT.TH1D("P_gtr_p_protons_dummysub_data_cut_all", "SHMS p; SHMS_gtr_p; Counts", 120, 1, 7)
P_dc_x_fp_protons_dummysub_data_cut_all = ROOT.TH1D("P_dc_x_fp_protons_dummysub_data_cut_all", "SHMS x_fp'; SHMS_dc_x_fp; Counts", 120, -100, 100)
P_dc_y_fp_protons_dummysub_data_cut_all = ROOT.TH1D("P_dc_y_fp_protons_dummysub_data_cut_all", "SHMS y_fp'; SHMS_dc_y_fp; Counts", 120, -100, 100)
P_dc_xp_fp_protons_dummysub_data_cut_all = ROOT.TH1D("P_dc_xp_fp_protons_dummysub_data_cut_all", "SHMS xp_fp'; SHMS_dc_xp_fp; Counts", 120, -0.2, 0.2)
P_dc_yp_fp_protons_dummysub_data_cut_all = ROOT.TH1D("P_dc_yp_fp_protons_dummysub_data_cut_all", "SHMS yp_fp'; SHMS_dc_yp_fp; Counts", 120, -0.2, 0.2)
P_hod_goodscinhit_protons_dummysub_data_cut_all = ROOT.TH1D("P_hod_goodscinhit_protons_dummysub_data_cut_all", "SHMS hod goodscinhit; SHMS_hod_goodscinhit; Counts", 120, 0.7, 1.3)
P_hod_goodstarttime_protons_dummysub_data_cut_all = ROOT.TH1D("P_hod_goodstarttime_protons_dummysub_data_cut_all", "SHMS hod goodstarttime; SHMS_hod_goodstarttime; Counts", 120, 0.7, 1.3)
P_cal_etotnorm_protons_dummysub_data_cut_all = ROOT.TH1D("P_cal_etotnorm_protons_dummysub_data_cut_all", "SHMS cal etotnorm; SHMS_cal_etotnorm; Counts", 120, 0, 1)
P_cal_etottracknorm_protons_dummysub_data_cut_all = ROOT.TH1D("P_cal_etottracknorm_protons_dummysub_data_cut_all", "SHMS cal etottracknorm; SHMS_cal_etottracknorm; Counts", 120, 0, 1.6)
P_hgcer_npeSum_protons_dummysub_data_cut_all = ROOT.TH1D("P_hgcer_npeSum_protons_dummysub_data_cut_all", "SHMS HGC npeSum; SHMS_hgcer_npeSum; Counts", 120, 0, 50)
P_hgcer_xAtCer_protons_dummysub_data_cut_all = ROOT.TH1D("P_hgcer_xAtCer_protons_dummysub_data_cut_all", "SHMS HGC xAtCer; SHMS_hgcer_xAtCer; Counts", 120, -60, 60)
P_hgcer_yAtCer_protons_dummysub_data_cut_all = ROOT.TH1D("P_hgcer_yAtCer_protons_dummysub_data_cut_all", "SHMS HGC yAtCer; SHMS_hgcer_yAtCer; Counts", 120, -50, 50)
P_ngcer_npeSum_protons_dummysub_data_cut_all = ROOT.TH1D("P_ngcer_npeSum_protons_dummysub_data_cut_all", "SHMS NGC npeSum; SHMS_ngcer_npeSum; Counts", 120, 0, 50)
P_ngcer_xAtCer_protons_dummysub_data_cut_all = ROOT.TH1D("P_ngcer_xAtCer_protons_dummysub_data_cut_all", "SHMS NGC xAtCer; SHMS_ngcer_xAtCer; Counts", 120, -60, 60)
P_ngcer_yAtCer_protons_dummysub_data_cut_all = ROOT.TH1D("P_ngcer_yAtCer_protons_dummysub_data_cut_all", "SHMS NGC yAtCer; SHMS_ngcer_yAtCer; Counts", 120, -50, 50)
P_aero_npeSum_protons_dummysub_data_cut_all = ROOT.TH1D("P_aero_npeSum_protons_dummysub_data_cut_all", "SHMS aero npeSum; SHMS_aero_npeSum; Counts", 120, 0, 50)
P_aero_xAtAero_protons_dummysub_data_cut_all = ROOT.TH1D("P_acero_xAtAero_protons_dummysub_data_cut_all", "SHMS aero xAtAero; SHMS_aero_xAtAero; Counts", 120, -60, 60)
P_aero_yAtAero_protons_dummysub_data_cut_all = ROOT.TH1D("P_aero_yAtAero_protons_dummysub_data_cut_all", "SHMS aero yAtAero; SHMS_aero_yAtAero; Counts", 120, -50, 50)
P_kin_MMp_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_MMp_protons_dummysub_data_cut_all", "MIssing Mass data (dummysub_cut_all); MM_{p}; Counts", 120, -1., 1.)
P_RFTime_Dist_protons_dummysub_data_cut_all = ROOT.TH1D("P_RFTime_Dist_protons_dummysub_data_cut_all", "SHMS RFTime; SHMS_RFTime; Counts", 120, 0, 4)
CTime_epCoinTime_ROC1_protons_dummysub_data_cut_all = ROOT.TH1D("CTime_epCoinTime_ROC1_protons_dummysub_data_cut_all", "Electron-Proton CTime; e p Coin_Time; Counts", 120, -50, 50)
P_kin_secondary_pmiss_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_protons_dummysub_data_cut_all", "Momentum Distribution; pmiss; Counts", 120, -0.8, 0.8)
P_kin_secondary_pmiss_x_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_x_protons_dummysub_data_cut_all", "Momentum_x Distribution; pmiss_x; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_y_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_y_protons_dummysub_data_cut_all", "Momentum_y Distribution; pmiss_y; Counts", 120, -0.6, 0.6)
P_kin_secondary_pmiss_z_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_pmiss_z_protons_dummysub_data_cut_all", "Momentum_z Distribution; pmiss_z; Counts", 120, -0.6, 0.6)
P_kin_secondary_Erecoil_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_Erecoil_protons_dummysub_data_cut_all", "Erecoil Distribution; Erecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all", "Energy Distribution; emiss_nuc; Counts", 120, -0.8, 0.8)
P_kin_secondary_Mrecoil_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_Mrecoil_protons_dummysub_data_cut_all", "Mrecoil Distribution; Mrecoil; Counts", 120, -0.8, 0.8)
P_kin_secondary_W_protons_dummysub_data_cut_all = ROOT.TH1D("P_kin_secondary_W_protons_dummysub_data_cut_all", "W Distribution; W; Counts", 120, 0, 2)
MMsquared_dummysub_data_cut_all = ROOT.TH1D("MMsquared_dummysub_data_cut_all", "Missing Mass Squared; MM^{2}_{p}; Counts", 120, -1., 1.)

# Uncut SIMC Histograms
H_hsdelta_protons_simc_cut_all = ROOT.TH1D("H_hsdelta_protons_simc_cut_all", "HMS #delta; HMS_#delta; Counts", 120, -15, 15)
H_hsxptar_protons_simc_cut_all = ROOT.TH1D("H_hsxptar_protons_simc_cut_all", "HMS xptar; HMS_xptar; Counts", 120, -0.2, 0.2)
H_hsyptar_protons_simc_cut_all = ROOT.TH1D("H_hsyptar_protons_simc_cut_all", "HMS yptar; HMS_yptar; Counts", 120, -0.2, 0.2)
H_hsytar_protons_simc_cut_all = ROOT.TH1D("H_hsytar_protons_simc_cut_all", "HMS ytar; HMS_ytar; Counts", 120, -20, 20)
H_hsxfp_protons_simc_cut_all = ROOT.TH1D("H_hsxfp_protons_simc_cut_all", "HMS x_fp'; HMS_xfp; Counts", 120, -100, 100)
H_hsyfp_protons_simc_cut_all = ROOT.TH1D("H_hsyfp_protons_simc_cut_all", "HMS y_fp'; HMS_yfp; Counts", 120, -100, 100)
H_hsxpfp_protons_simc_cut_all = ROOT.TH1D("H_hsxpfp_protons_simc_cut_all", "HMS xp_fp'; HMS_xpfp; Counts", 120, -0.2, 0.2)
H_hsypfp_protons_simc_cut_all = ROOT.TH1D("H_hsypfp_protons_simc_cut_all", "HMS yp_fp'; HMS_ypfp; Counts", 120, -0.2, 0.2)
H_hsdeltai_protons_simc_cut_all = ROOT.TH1D("H_hsdeltai_protons_simc_cut_all", "HMS #delta i; HMS_#delta i; Counts", 120, -15, 15)
H_hsxptari_protons_simc_cut_all = ROOT.TH1D("H_hsxptari_protons_simc_cut_all", "HMS xptari; HMS_xptari; Counts", 120, -0.2, 0.2)
H_hsyptari_protons_simc_cut_all = ROOT.TH1D("H_hsyptari_protons_simc_cut_all", "HMS yptari; HMS_yptari; Counts", 120, -0.2, 0.2)
H_hsytari_protons_simc_cut_all = ROOT.TH1D("H_hsytari_protons_simc_cut_all", "HMS ytari; HMS_ytari; Counts", 120, -20, 20)
P_ssdelta_protons_simc_cut_all = ROOT.TH1D("P_ssdelta_protons_simc_cut_all", "SHMS #delta; SHMS_#delta; Counts", 120, -30, 30)
P_ssxptar_protons_simc_cut_all = ROOT.TH1D("P_ssxptar_protons_simc_cut_all", "SHMS xptar; SHMS_xptar; Counts", 120, -0.2, 0.2)
P_ssyptar_protons_simc_cut_all = ROOT.TH1D("P_ssyptar_protons_simc_cut_all", "SHMS yptar; SHMS_yptar; Counts", 120, -0.2, 0.2)
P_ssytar_protons_simc_cut_all = ROOT.TH1D("P_ssytar_protons_simc_cut_all", "SHMS ytar; SHMS_ytar; Counts", 120, -20, 20)
P_ssxfp_protons_simc_cut_all = ROOT.TH1D("P_ssxfp_protons_simc_cut_all", "SHMS x_fp'; SHMS_xfp; Counts", 120, -100, 100)
P_ssyfp_protons_simc_cut_all = ROOT.TH1D("P_ssyfp_protons_simc_cut_all", "SHMS y_fp'; SHMS_yfp; Counts", 120, -100, 100)
P_ssxpfp_protons_simc_cut_all = ROOT.TH1D("P_ssxpfp_protons_simc_cut_all", "SHMS xp_fp'; SHMS_xpfp; Counts", 120, -0.2, 0.2)
P_ssypfp_protons_simc_cut_all = ROOT.TH1D("P_ssypfp_protons_simc_cut_all", "SHMS yp_fp'; SHMS_ypfp; Counts", 120, -0.2, 0.2)
P_ssdeltai_protons_simc_cut_all = ROOT.TH1D("P_ssdeltai_protons_simc_cut_all", "SHMS #delta i; SHMS_#delta i; Counts", 120, -30, 30)
P_ssxptari_protons_simc_cut_all = ROOT.TH1D("P_ssxptari_protons_simc_cut_all", "SHMS xptari; SHMS_xptari; Counts", 120, -0.2, 0.2)
P_ssyptari_protons_simc_cut_all = ROOT.TH1D("P_ssyptari_protons_simc_cut_all", "SHMS yptari; SHMS_yptari; Counts", 120, -0.2, 0.2)
P_ssytari_protons_simc_cut_all = ROOT.TH1D("P_ssytari_protons_simc_cut_all", "SHMS ytari; SHMS_ytari; Counts", 120, -20, 20)
q_protons_simc_cut_all = ROOT.TH1D("q_protons_simc_cut_all", "q Distribution; q; Counts", 120, 0, 10)
nu_protons_simc_cut_all = ROOT.TH1D("nu_protons_simc_cut_all", "nu Distribution; nu; Counts", 120, 0, 10)
Q2_protons_simc_cut_all = ROOT.TH1D("Q2_protons_simc_cut_all", "#Q^2 Distribution; #Q^2; Counts", 120, 0, 15)
epsilon_protons_simc_cut_all = ROOT.TH1D("epsilon_protons_simc_cut_all", "epsilon Distribution; #epsilon; Counts", 120, 0, 2)
thetapq_protons_simc_cut_all = ROOT.TH1D("thetapq_protons_simc_cut_all", "thetapq Distribution; thetapq; Counts", 120, -1, 1)
phipq_protons_simc_cut_all = ROOT.TH1D("phipq_protons_simc_cut_all", "phipq Distribution; phipq; Counts", 120, -2, 8)
pmiss_protons_simc_cut_all = ROOT.TH1D("pmiss_protons_simc_cut_all", "Momentum Distribution; pmiss; Counts", 120, -0.8, 0.8)
pmiss_x_protons_simc_cut_all = ROOT.TH1D("pmiss_x_protons_simc_cut_all", "Momentum_x Distribution; pmiss_x; Counts", 120, -0.6, 0.6)
pmiss_y_protons_simc_cut_all = ROOT.TH1D("pmiss_y_protons_simc_cut_all", "Momentum_y Distribution; pmiss_y; Counts", 120, -0.6, 0.6)
pmiss_z_protons_simc_cut_all = ROOT.TH1D("pmiss_z_protons_simc_cut_all", "Momentum_z Distribution; pmiss_z; Counts", 120, -0.6, 0.6)
emiss_protons_simc_cut_all = ROOT.TH1D("emiss_protons_simc_cut_all", "Energy Distribution; emiss; Counts", 120, -0.8, 0.8)
W_protons_simc_cut_all = ROOT.TH1D("W_protons_simc_cut_all", "W Distribution; W; Counts", 120, 0, 2)
MMp_protons_simc_cut_all = ROOT.TH1D("MMp_protons_simc_cut_all", "MIssing Mass SIMC (cut_all); MM_{p}; Counts", 120, -1, 1)
...
for event in Uncut_Proton_Events_Data_tree:
    ...
    P_kin_secondary_emiss_nuc_protons_data_uncut.Fill(event.emiss_nuc)
...
for event in Cut_Proton_Events_All_Data_tree:
    ...
    P_kin_secondary_emiss_nuc_protons_data_cut_all.Fill(event.emiss_nuc)
...
for event in Cut_Proton_Events_Prompt_Data_tree:
    ...
    P_kin_secondary_emiss_nuc_protons_data_prompt_cut_all.Fill(event.emiss_nuc)
...
for event in Cut_Proton_Events_Prompt_Dummy_tree:
    ...
    P_kin_secondary_emiss_nuc_protons_dummy_prompt_cut_all.Fill(event.emiss_nuc)
...
for event in Cut_Proton_Events_Prompt_Data_tree:
    ...
    P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.Fill(event.emiss_nuc)
...
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.Scale(normfac_data)
...
P_kin_secondary_emiss_nuc_protons_dummy_prompt_cut_all.Scale(normfac_dummy)
...
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.Add(P_kin_secondary_emiss_nuc_protons_dummy_prompt_cut_all,-1)
...
c1_fit = TCanvas("c1_fit", "Missing Mass and Momentum Distributions", 5, 5, 1300,600)
c1_fit.Divide(3,2)
...
#pmiss_x_protons_simc_cut_all.GetXaxis().SetRangeUser(-0.2, 0.2)
...
pmiss_x_legend = TLegend(0.55, 0.7, 0.9, 0.9)
...
#pmiss_y_protons_simc_cut_all.GetXaxis().SetRangeUser(-0.2, 0.2)
...
pmiss_y_legend = TLegend(0.55, 0.7, 0.9, 0.9)
...
#pmiss_z_protons_simc_cut_all.GetXaxis().SetRangeUser(-0.2, 0.2)
...
pmiss_z_legend = TLegend(0.55, 0.7, 0.9, 0.9)
...
tmp_b_mean_emiss_nuc_data = fit_gaussian(P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all,-0.1, 0.1, "data")
b_mean_emiss_nuc_data = tmp_b_mean_emiss_nuc_data[0]
b_mean_err_emiss_nuc_data = tmp_b_mean_emiss_nuc_data[1]
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.GetXaxis().SetRangeUser(-0.2, 0.2)
...
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.SetLineColor(kBlue)
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.Draw("E1")
emiss_protons_simc_cut_all.SetLineColor(kRed)
emiss_protons_simc_cut_all.Draw("same, E1")
emiss_legend = TLegend(0.55, 0.7, 0.9, 0.9)
...
emiss_legend.AddEntry(P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all, "DATA (Blue)", "lp")
emiss_legend.AddEntry(emiss_protons_simc_cut_all,"MEAN = {:.4e}\pm{:.4e}".format(b_mean_emiss_nuc_data, b_mean_err_emiss_nuc_data))
emiss_legend.AddEntry(P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all,"MEAN = {:.4e}\pm{:.4e}".format(b_mean_emiss_simc, b_mean_err_emiss_simc))
emiss_legend.Draw()
emiss_fit_func_simc = emiss_protons_simc_cut_all.GetFunction('gaus')
emiss_fit_func_simc.SetLineWidth(1)
emiss_fit_func_data = P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.GetFunction('gaus')
...
W_legend = TLegend(0.55, 0.7, 0.9, 0.9)
...
c1_delta = TCanvas("c1_delta", "Delta and Target Distributions", 100, 0, 2800, 1200)
c1_delta.Divide(3,2)
c1_delta.cd(1)
#pmiss_text = TText(0.5, 0.5, "text")
pmiss_text_lines = [
    TText(0.5, 0.9, "HeePCoin Setting"),
    TText(0.5, 0.8, "Beam Energy = 10.549"),
    TText(0.5, 0.7, "HMS_p = -5.878"),
    TText(0.5, 0.6, "HMS_theta = 21.670"),
    TText(0.5, 0.5, "SHMS_p = 5.539"),
    TText(0.5, 0.4, "SHMS_theta = 23.110")
]
for pmiss_text in pmiss_text_lines:
    pmiss_text.SetTextSize(0.07)
    pmiss_text.SetTextAlign(22)
    pmiss_text.Draw()
c1_delta.cd(2)
...
c1_tar = TCanvas("c1_tar", "Focal Plane and Target Distributions", 100, 0, 2800, 1200)
c1_tar.Divide(3,2)
c1_tar.cd(1)
...
c1_pmiss = TCanvas("c1_pmiss", "Missing Mass and Momentum Distributions", 100, 0, 2800, 1200)
c1_pmiss.Divide(3,2)
c1_fit.cd(1)
tmp_b_mean_pmiss_x_simc = fit_gaussian(pmiss_x_protons_simc_cut_all,-0.1, 0.1, "simc")
b_mean_pmiss_x_simc = tmp_b_mean_pmiss_x_simc[0]
...
pmiss_protons_simc_cut_all.GetXaxis().SetRangeUser(-0.2, 0.2)
...
pmiss_legend = TLegend(0.55, 0.7, 0.9, 0.9)
...
pmiss_legend.AddEntry(pmiss_protons_simc_cut_all,"MEAN = {:.4e}\pm{:.4e}".format(b_mean_pmiss_z_data, b_mean_err_pmiss_z_data))
pmiss_legend.AddEntry(P_kin_secondary_pmiss_protons_dummysub_data_cut_all,"MEAN = {:.4e}\pm{:.4e}".format(b_mean_pmiss_z_simc, b_mean_err_pmiss_z_simc))
pmiss_legend.Draw()
...
emiss_protons_simc_cut_all.Draw("E1")
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.SetLineColor(kBlue)
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.Draw("same, E1")
emiss_legend = TLegend(0.55, 0.7, 0.9, 0.9)
emiss_legend.SetBorderSize(1)
emiss_legend.SetFillColor(0)
emiss_legend.SetFillStyle(0)
...
W_fit_func_data = P_kin_secondary_W_protons_dummysub_data_cut_all.GetFunction('gaus')
W_fit_func_data.SetLineWidth(1)
c1_pmiss.Print(Proton_Analysis_Distributions + ')')
'''
#############################################################################################################################################
...
P_kin_secondary_emiss_nuc_protons_data_uncut.Write()
...
P_kin_secondary_emiss_nuc_protons_data_cut_all.Write()
...
P_kin_secondary_emiss_nuc_protons_data_prompt_cut_all.Write()
...
P_kin_secondary_emiss_nuc_protons_dummy_prompt_cut_all.Write()
...
P_kin_secondary_emiss_nuc_protons_dummysub_data_cut_all.Write()

...
if spec == "HMS":
    ...
    H_kin_secondary_W_protons_dummysub_data_cut_all = ROOT.TH1D("H_kin_secondary_W_protons_dummysub_data_cut_all", "W Distribution; W; Counts", nbins, 0, 2.0)
    ...
    H_kin_secondary_W_protons_dummy_prompt_cut_all = ROOT.TH1D("H_kin_secondary_W_protons_dummy_prompt_cut_all", "W Distribution; W; Counts", nbins, 0, 2.0)
...
for event in Cut_Proton_Events_Prompt_Data_tree:
    if spec == "HMS":
        ...
        H_kin_secondary_W_protons_dummysub_data_cut_all.Fill(event.W)
...
for event in Cut_Proton_Events_Prompt_Dummy_tree:
    if spec == "HMS":
        ...
        H_kin_secondary_W_protons_dummy_prompt_cut_all.Fill(event.W)
...
if spec == "HMS":
    ...
    H_kin_secondary_W_protons_dummysub_data_cut_all.Scale(normfac_data)
    # Dummy Normalization
    ...
    H_kin_secondary_W_protons_dummy_prompt_cut_all.Scale(normfac_dummy)
    # SIMC Normalization
...
if spec == "HMS":
    ...
    H_kin_secondary_W_protons_dummysub_data_cut_all.Add(H_kin_secondary_W_protons_dummy_prompt_cut_all,-1)
if spec == "SHMS":
...
if spec == "HMS":
    ...
    N_data_W = H_kin_secondary_W_protons_dummysub_data_cut_all.IntegralAndError(1,nbins,dN_data_W,"")
...
if spec == "HMS":
    ...
    H_kin_secondary_W_protons_dummysub_data_cut_all.Write()
if spec == "SHMS":

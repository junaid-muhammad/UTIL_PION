...
c1_fit_text_lines = [
    ...
    TText(0.5, 0.3, "SIMC = Red"),
    TText(0.5, 0.2, "Data = Blue")
    ]
# Set color to blue for the specific lines
c1_fit_text_lines[6].SetTextColor(kRed)  # Change "SIMC = Red" to red
c1_fit_text_lines[7].SetTextColor(kBlue)  # Change "Data = Blue" to blue

...
y_max1 = 42500  # Set your y-axis maximum range
...
for bin_num1 in range(BinLow1, BinHigh1 + 1):
    ...
    if y_min1 <= bin_content1 <= y_max1:
        integral_bkregion1 += bin_content1
...
y_max2 = 30000  # Set your y-axis maximum range
...
for bin_num2 in range(BinLow2, BinHigh2 + 1):
    ...
    if y_min2 <= bin_content2 <= y_max2:
        integral_bkregion2 += bin_content2
...
y_max3 = 5500  # Set your y-axis maximum range
...
for bin_num3 in range(BinLow3, BinHigh3 + 1):
    ...
    if y_min3 <= bin_content3 <= y_max3:
        integral_bkregion3 += bin_content3
...
y_max4 = 4500  # Set your y-axis maximum range
...
for bin_num4 in range(BinLow4, BinHigh4 + 1):
    ...
    if y_min4 <= bin_content4 <= y_max4:
        integral_bkregion4 += bin_content4
...
y_max5 = 4000  # Set your y-axis maximum range
...
for bin_num5 in range(BinLow5, BinHigh5 + 1):
    ...
    if y_min5 <= bin_content5 <= y_max5:
        integral_bkregion5 += bin_content5

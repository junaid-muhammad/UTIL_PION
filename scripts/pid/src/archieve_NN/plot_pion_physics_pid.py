...
#    SHMS_PID_Cut = (event.P_hgcer_npeSum > P_hgcer_npeSum_cut_value)
...
'''
H_gtr_beta_pions_data_cut_all = H_gtr_beta_pions_data_prompt_cut_all.Clone()
H_cal_etottracknorm_pions_data_cut_all = H_cal_etottracknorm_pions_data_prompt_cut_all.Clone()
H_cer_npeSum_pions_data_cut_all = H_cer_npeSum_pions_data_prompt_cut_all.Clone()
H_RFTime_Dist_pions_data_cut_all = H_RFTime_Dist_pions_data_prompt_cut_all.Clone()
P_gtr_beta_pions_data_cut_all = P_gtr_beta_pions_data_prompt_cut_all.Clone()
P_cal_etottracknorm_pions_data_cut_all = P_cal_etottracknorm_pions_data_prompt_cut_all.Clone()
P_hgcer_npeSum_pions_data_cut_all = P_hgcer_npeSum_pions_data_prompt_cut_all.Clone()
P_hgcer_xAtCer_pions_data_cut_all = P_hgcer_xAtCer_pions_data_prompt_cut_all.Clone()
P_hgcer_yAtCer_pions_data_cut_all = P_hgcer_yAtCer_pions_data_prompt_cut_all.Clone()
P_ngcer_npeSum_pions_data_cut_all = P_ngcer_npeSum_pions_data_prompt_cut_all.Clone()
P_ngcer_xAtCer_pions_data_cut_all = P_ngcer_xAtCer_pions_data_prompt_cut_all.Clone()
P_ngcer_yAtCer_pions_data_cut_all = P_ngcer_yAtCer_pions_data_prompt_cut_all.Clone()
P_aero_npeSum_pions_data_cut_all = P_aero_npeSum_pions_data_prompt_cut_all.Clone()
P_aero_xAtAero_pions_data_cut_all = P_aero_xAtAero_pions_data_prompt_cut_all.Clone()
P_aero_yAtAero_pions_data_cut_all = P_aero_yAtAero_pions_data_prompt_cut_all.Clone()
P_RFTime_Dist_pions_data_cut_all = P_RFTime_Dist_pions_data_prompt_cut_all.Clone()
CTime_ePiCoinTime_ROC1_pions_data_cut_all = CTime_ePiCoinTime_ROC1_pions_data_prompt_cut_all.Clone()
H_cal_etottracknorm_vs_cer_npeSum_pions_cut_all = H_cal_etottracknorm_vs_cer_npeSum_pions_prompt_cut_all.Clone()
P_hgcer_vs_aero_npe_pions_cut_all = P_hgcer_vs_aero_npe_pions_prompt_cut_all.Clone()
P_ngcer_vs_hgcer_npe_pions_cut_all = P_ngcer_vs_hgcer_npe_pions_prompt_cut_all.Clone()
P_ngcer_vs_aero_npe_pions_cut_all = P_ngcer_vs_aero_npe_pions_prompt_cut_all.Clone()
P_hgcer_yAtCer_vs_hgcer_xAtCer_pions_cut_all = P_hgcer_yAtCer_vs_hgcer_xAtCer_pions_prompt_cut_all.Clone()
P_aero_yAtAero_vs_aero_xAtAero_pions_cut_all = P_aero_yAtAero_vs_aero_xAtAero_pions_prompt_cut_all.Clone()
P_ngcer_yAtCer_vs_ngcer_xAtCer_pions_cut_all = P_ngcer_yAtCer_vs_ngcer_xAtCer_pions_prompt_cut_all.Clone()
P_cal_etottracknorm_vs_ngcer_npe_pions_cut_all = P_cal_etottracknorm_vs_ngcer_npe_pions_prompt_cut_all.Clone()
CTime_ePiCoinTime_vs_MMpi_pions_cut_all = CTime_ePiCoinTime_vs_MMpi_pions_prompt_cut_all.Clone()
CTime_ePiCoinTime_vs_beta_pions_cut_all = CTime_ePiCoinTime_vs_beta_pions_prompt_cut_all.Clone()
P_RFTime_vs_MMpi_pions_cut_all = P_RFTime_vs_MMpi_pions_prompt_cut_all.Clone()
CTime_ePiCoinTime_vs_RFTime_pions_cut_all = CTime_ePiCoinTime_vs_RFTime_pions_prompt_cut_all.Clone()
P_HGC_xy_npe_pions_cut_all = P_HGC_xy_npe_pions_prompt_cut_all.Clone()
P_Aero_xy_npe_pions_cut_all = P_Aero_xy_npe_pions_prompt_cut_all.Clone()
P_NGC_xy_npe_pions_cut_all = P_NGC_xy_npe_pions_prompt_cut_all.Clone()
'''
############################################################################################################################################
...
P_kin_MMpi_pions_data_accpt_cut_all.Draw("hist same")
P_kin_MMpi_pions_data_cut_all.SetLineColor(4)
P_kin_MMpi_pions_data_cut_all.Draw("hist same")
# Section for Neutron Peak Events Selection
shadedpeak_pions = P_kin_MMpi_pions_data_cut_all.Clone()
...
BinLow_pions = P_kin_MMpi_pions_data_cut_all.GetXaxis().FindBin(minbin)
BinHigh_pions = P_kin_MMpi_pions_data_cut_all.GetXaxis().FindBin(maxbin)
BinIntegral_pions = int(P_kin_MMpi_pions_data_cut_all.Integral(BinLow_pions, BinHigh_pions))
...
c1_pid1.cd(3)
P_RFTime_Dist_pions_data_uncut.SetLineColor(1)
P_RFTime_Dist_pions_data_uncut.Draw()
c1_pid1.cd(4)
#gPad.SetLogy()
...
legend2_pions.AddEntry("P_RFTime_Dist_pions_data_uncut", "with cuts (acpt)", "l")
legend2_pions.AddEntry("P_RFTime_Dist_pions_data_cut_all", "with cuts (acpt/CT/PID)", "l")

...
ax1.set_ylabel('Electron Tracking Efficiency', fontsize=12)
...
ax2.set_xlim(0,3200)
ax2.set_ylabel('Pion Tracking Efficiency', fontsize=12)
ax2.set_xlabel('SHMS EL-REAL Trigger Rate [kHz]', fontsize=12)
...
plt.tight_layout(rect=[0,0.03,1,0.95])
plt.savefig(UTILPATH+'/scripts/efficiency/OUTPUTS/plots/SHMS_Track_EFF_vs_S1X_Rate.png')

...
E10p549_yerr = math.sqrt((E10p549_Pmy_simc.std_dev / E10p549_HMS_Pe)**2 + (E10p549_Pmy_data.std_dev / E10p549_HMS_Pe)**2 + (0.00137 / E10p549_HMS_Pe)**2)
...
E5p986_yerr = math.sqrt((E5p986_Pmy_simc.std_dev / E5p986_HMS_Pe)**2 + (E5p986_Pmy_data.std_dev / E5p986_HMS_Pe)**2 + (0.00137 / E5p986_HMS_Pe)**2)
...
E6p395s1_yerr = math.sqrt((E6p395s1_Pmy_simc.std_dev / E6p395s1_HMS_Pe)**2 + (E6p395s1_Pmy_data.std_dev / E6p395s1_HMS_Pe)**2 + (0.00137 / E6p395s1_HMS_Pe)**2)
...
E6p395s2_yerr = math.sqrt((E6p395s2_Pmy_simc.std_dev / E6p395s2_HMS_Pe)**2 + (E6p395s2_Pmy_data.std_dev / E6p395s2_HMS_Pe)**2 + (0.00137 / E6p395s2_HMS_Pe)**2)
...
E6p395s3_yerr = math.sqrt((E6p395s3_Pmy_simc.std_dev / E6p395s3_HMS_Pe)**2 + (E6p395s3_Pmy_data.std_dev / E6p395s3_HMS_Pe)**2 + (0.00137 / E6p395s3_HMS_Pe)**2)
...
E7p937_yerr = math.sqrt((E7p937_Pmy_simc.std_dev / E7p937_HMS_Pe)**2 + (E7p937_Pmy_data.std_dev / E7p937_HMS_Pe)**2 + (0.00137 / E7p937_HMS_Pe)**2)
...
E8p479_yerr = math.sqrt((E8p479_Pmy_simc.std_dev / E8p479_HMS_Pe)**2 + (E8p479_Pmy_data.std_dev / E8p479_HMS_Pe)**2 + (0.00137 / E8p479_HMS_Pe)**2)
...
E9p177_yerr = math.sqrt((E9p177_Pmy_simc.std_dev / E9p177_HMS_Pe)**2 + (E9p177_Pmy_data.std_dev / E9p177_HMS_Pe)**2 + (0.00137 / E9p177_HMS_Pe)**2)
...
E9p876_yerr = math.sqrt((E9p876_Pmy_simc.std_dev / E9p876_HMS_Pe)**2 + (E9p876_Pmy_data.std_dev / E9p876_HMS_Pe)**2 + (0.00137 / E9p876_HMS_Pe)**2)
